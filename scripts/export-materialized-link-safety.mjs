...
const outDir = path.resolve(process.argv[2] || path.join('public', '_materialized-link-safety'))
...
console.log(`[materialized-link-safety-export] exported ${files.length} generated product files to ${outDir}`)
