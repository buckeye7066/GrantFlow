...
if (!CLAUDE_API_KEY) {
  console.error('[ocr-anastasia-images] ANTHROPIC_API_KEY is required.')
  process.exit(1)
}
if (!PDF_PATH) {
  console.error('[ocr-anastasia-images] PDF_PATH is required. Provide via env PDF_PATH or first CLI argument.')
  process.exit(1)
}
