...
const NATIONAL_PROGRAMS = [
  ...
  },
  {
    ...
    description: 'Monthly cash payments for aged, blind, or disabled people with limited income and resources. 2024 federal max: $943/month individual, $1,415/month couple.',
    amount_min: 100, amount_max: 943, // Per-month amounts (individual); couples max $1,415
  ...
  },
  {
    ...
    description: 'Monthly benefits for workers who become disabled and cannot work, based on work history. 2024 max: $3,822/month.',
    amount_min: 100, amount_max: 3822, // Per-month; actual benefit depends on work history
  ...
  // FEDERAL EDUCATION GRANTS
  {
    ...
    description: 'Federal grant for undergraduate students with exceptional financial need. Max $7,395/year (2024-25 and 2025-26 award years). Apply via FAFSA.',
  ...
  // VA Home Loan removed - loans not included per user request
  {
    ...
    description: 'Tax-free monthly payments for veterans with service-connected disabilities. 2024 rates: 10% rating ~$171/month to 100% rating ~$3,737/month (higher with dependents).',
    amount_min: 165, amount_max: 3737, // 2024 base rates; Special Monthly Compensation can exceed this
