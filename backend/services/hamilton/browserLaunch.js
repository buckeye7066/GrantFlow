 ...
 * Public HTTPS portal URLs and the reserved synthetic fixture are allowed.
 * Private / loopback / metadata targets are refused forever (SSRF).
...
export async function launchPortalBrowser(chromium, { headless = true, extraArgs = [], targetUrl = null } = {}) {
  if (targetUrl != null && targetUrl !== '' && !isHamiltonBrowserTargetAllowed(targetUrl)) {
