/**
 * hamiltonESignatureService.js
 *
 * Signature handling. Hamilton never forges signatures. She produces:
 *
 ...
 *      Adobe Sign, etc.). Hamilton hands back the envelope description;
...
/**
 * Build an e-sign envelope description Hamilton can hand to a downstream
...
export function buildWetSignatureInstructions({ opportunity = null }) {
  return {
    ...
    instructions: [
      ...
      'Sign every page where Hamilton highlighted the signature line.',
