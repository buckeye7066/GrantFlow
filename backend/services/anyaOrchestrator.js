 ...
 if (isHealthQuery) {
  ...
  if (isAdmin) {
    systemPromptParts.push(
      ...
      '',
      'Crawler Operations:',
      '- admin.crawler.run: Run any crawler type (comprehensive, local_funding, government_funding, student_grants, health_resources, special_needs, ecf_benefits, item_matching)',
