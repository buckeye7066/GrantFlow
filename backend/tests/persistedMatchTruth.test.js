...
describe('owner-facing persisted match truth', () => {
  ...
  it('keeps a directory as REVIEW even when a historical row says ACCEPT', () => {
    const canonical = [{
      id: 'directory-1',
      title: 'Scholarship Directory',
      sponsor: 'Directory Sponsor',
      application_url: 'https://example.org/directory',
  ...
  it('collapses historical cross-source duplicates and keeps the highest stored score', () => {
    const canonical = [
      {
        id: 'a',
  ...
  it('pins the funding-source route to the persisted-truth restoration boundary', () => {
