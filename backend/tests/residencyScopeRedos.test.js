...
describe('residency-scope pattern — pathological input stays linear', () => {
  ...
  it('is linear, not quadratic: equal total input stays in the same cost band', () => {
