...
function makeDb() {
  ...
  ins.run('student-a', 'fo-promise', 'Tennessee Promise', 'strict_pipeline:qualifies:applicant_type:pass', 'migration:999_strict_pipeline_task_reconciliation')
  ins.run('student-a', 'fo-gates', 'The Gates Scholarship', 'strict_pipeline:qualifies:applicant_type:pass', 'migration:1000_fail_closed_hamilton_reconciliation')
  ins.run('student-a', 'fo-dir', 'Muncrief Family Foundation', 'strict_pipeline:relatable:directory_only', 'migration:999_strict_pipeline_task_reconciliation')
  ins.run('student-a', 'fo-user', 'Something the user removed', 'user_deleted_from_pipeline', 'user-1')
  ...
  out.run('student-a', 'fo-promise', 'live', 'tombstoned', 'strict_pipeline', )
  out.run('student-a', 'fo-dir', 'live', 'source_excluded', 'directory', )
