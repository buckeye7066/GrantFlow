...
export function upsertOpportunity(store, opp) {
  ...
  store.upsert('funding_opportunities', ['id'], {
    ...
    first_published_at: opp.first_published_at ?? null,
    required_documents_json: JSON.stringify(opp.required_documents ?? []),
    application_method: opp.application_method ?? null,
...
CREATE TABLE IF NOT EXISTS funding_opportunities (
  ...
  purpose TEXT, open_date TEXT, recurrence TEXT, source_status TEXT,
  first_published_at TEXT, required_documents_json TEXT, application_method TEXT,
