...
// Over-stripping is a security bug here: if two distinct inventory links
// collapse to one identity, a model can smuggle a non-inventory URL past the
// membership check (?ref=grant-A vs ?ref=grant-B must stay DISTINCT).
