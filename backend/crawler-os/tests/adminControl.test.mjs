...
import { createAdminControl, ADMIN_EMAIL, CONTROL_STATE } from '../adminControl.js';

const ADMIN = ADMIN_EMAIL; // buckeye7066@gmail.com
const NOT_ADMIN = 'someone@else.com';

test('the control center starts idle and the admin can start it', () => {
  const ctl = createAdminControl({ store: createMemoryStore() });
