...
export const SOURCES = Object.freeze([
  ...
  },
  {
    ...
    directory: true, loan_allowed: false, cost_share_allowed: false,
    applicant_types: ['veteran', 'active_duty', 'guard_reserve', 'transitioning_service_member', 'military_spouse', 'business', 'individual'],
  ...
  },
  {
    ...
    directory: true, loan_allowed: false, cost_share_allowed: false,
    applicant_types: ['active_duty', 'guard_reserve', 'transitioning_service_member', 'military_spouse', 'family'],
    need_categories: ['active_duty_support', 'military_transition', 'military_spouse_support', 'employment', 'education', 'housing', 'medical'],
    geography: { national: true, states: [] },
    default_kinds: [OPPORTUNITY_KIND.DIRECTORY],
  ...
  },
  {
    ...
    directory: true, loan_allowed: false, cost_share_allowed: false,
    applicant_types: ['transitioning_service_member', 'active_duty', 'guard_reserve', 'veteran', 'military_spouse', 'business', 'individual'],
    need_categories: ['military_startup', 'veteran_startup', 'startup', 'employment'],
    geography: { national: true, states: [] },
    default_kinds: [OPPORTUNITY_KIND.DIRECTORY],
    crawler_method: 'html', requires_env: [], refresh_frequency_days: 30, priority_score: 72,
  },
