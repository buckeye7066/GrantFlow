...
-- user. Twin of sqlite migration 147_users_primary_phone_unique.sql. Backstop for
...
-- nulls the duplicates' primary_phone, so the forward repair migration 0152 (which
