-- Postgres init schema (generated from backend/db/schema.sql)
-- NOTE: uses pgcrypto for gen_random_uuid()
...
CREATE TABLE IF NOT EXISTS funding_opportunities (
  ...
  last_verified_at TIMESTAMPTZ, -- Last time this was verified as real
...
CREATE TABLE IF NOT EXISTS nf_programs_a (
  ...
  source_last_crawled_at TIMESTAMPTZ,
  last_verified TIMESTAMPTZ,
