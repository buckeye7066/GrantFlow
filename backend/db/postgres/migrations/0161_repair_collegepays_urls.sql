...
-- Twin: sqlite migration 157_repair_collegepays_urls.sql.
--
...
UPDATE system_kv
   SET value = (value::jsonb || '[
         {"label":"Tennessee STEP UP Scholarship","url_contains":"collegefortn.org/tennessee-step-up","expect_max":2850,"over_factor":3,"under_factor":5},
         {"label":"Aspire Award (HOPE supplement)","url_contains":"collegefortn.org/aspire-award","expect_max":750,"over_factor":4,"under_factor":5},
         {"label":"Tennessee HOPE Scholarship","url_contains":"collegefortn.org/tennessee-hope-scholarship","expect_max":2850,"over_factor":3,"under_factor":5}
       ]'::jsonb)::text,
       updated_at = now()
