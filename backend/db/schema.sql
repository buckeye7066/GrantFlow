...
-- ─── Profile pricing + access gate (mirrors migration 080) ──────────────────
-- Every profile receives an automatic pricing recommendation, captured in
-- profile_pricing. New non-admin users must accept the service agreement and
-- complete payment before unlocking the full app. admin_pricing_notifications
-- queues toasts for the only admin (buckeye7066@gmail.com).
