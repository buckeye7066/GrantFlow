...
CREATE TABLE IF NOT EXISTS funding_opportunities (
  ...
  source_url TEXT,
  record_origin TEXT DEFAULT 'live_crawl' CHECK(record_origin IN ('live_crawl','curated_verified','manual','synthetic','funding_api','url_import','directory_resource','directory:health_resources','directory:student_grants','discovered','geo_crawl','seeded','imported')),
