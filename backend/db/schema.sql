...
CREATE TABLE IF NOT EXISTS funding_opportunities (
  ...
  source_url TEXT,
  record_origin TEXT DEFAULT 'live_crawl' CHECK(record_origin IN ('live_crawl','curated_verified','curated_benefits','curated_program','scholarship_crawler','school_portal','grants_gov','verified_real','cof_foundation_locator','manual','synthetic','funding_api','url_import','directory_resource','directory:health_resources','directory:student_grants','discovered','geo_crawl','seeded','imported')),
