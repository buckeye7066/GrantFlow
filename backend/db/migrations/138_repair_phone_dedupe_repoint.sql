-- Round 24/25/26/27: FORWARD repair migration for phone-duplicate accounts.
--
...
-- Pre-map reconstruction (SQLite): a nulled dup whose profile still records the phone.
INSERT INTO phone_dedupe_map (dup_user_id, canonical_user_id, phone)
