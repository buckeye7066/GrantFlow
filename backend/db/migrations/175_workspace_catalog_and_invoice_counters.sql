-- 175: atomic consultant invoice counters + persist the last in-memory stub
-- entities (AiArtifact / PartnerSource / SearchJob / Taxonomy).
-- Postgres twin: backend/db/postgres/migrations/0180_workspace_catalog_and_invoice_counters.sql
