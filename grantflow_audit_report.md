...
- **Defects found:** 9
- **Files fixed:** 0
- **Errors recorded:** 45 (see the Errors section below; ledger at `C:\Users\firer\.flexfactor\runs\grantflow-20260826-173358-556165-36728\errors.md`)
...
**171620 entries accounted for.**

| Category | Count |
|---|---:|
| artifact-subtree | 50 |
| binary-asset | 1873 |
| configuration-documentation-or-data | 18360 |
...
- **Exact final commit:** `db005abf14ed9f3008ea882b2e021c781abc5fb8`
- **Code map:** 4207 file(s), 18879 function(s), 1261 route(s), 3832 material control(s)
...
- **Sources SKIPPED (named, not silent):**
  - `idea:Foundant Grant Lifecycle Manager` - model returned an incomplete idea (missing why_valuable) - forced to accept=False for Foundant Grant Lifecycle Manager
  ...
  - `idea:Submittable` - model returned an incomplete idea (missing why_valuable) - forced to accept=False for Submittable
...
- **Bridged into the fix stream:** 0 of 5 candidate(s)
  - NOT bridged (5): Foundant Grant Lifecycle Manager, OpenGrantStack/GrantReady-hub-SaaS, RockefellerArchiveCenter/fluxx_exporter, Submittable, ritchiea/recessart - idea rejected by the purpose contract
...
| [Submittable](https://www.submittable.com/solutions/grants) | market | `UNKNOWN` | `clean-room-from-documented-behavior` | purpose-only | reject | NOT entered - idea rejected by the purpose contract | (idea extraction failed) |
| [Foundant Grant Lifecycle Manager](https://www.foundant.com/products/login/) | market | `UNKNOWN` | `clean-room-from-documented-behavior` | purpose-only | reject | NOT entered - idea rejected by the purpose contract | (idea extraction failed) |
...
- **Value here:** 
- **Purpose / criterion mapping:** purpose-only - NOT ACTED ON: model returned an incomplete idea (missing why_valuable) - forced to accept=False. not judged: no strong route available (121 enabled routes in catalog). Pools skipped: cerebras:free-tier (pool cooling down); gemini:free-tier (pool cooling down); groq:free-tier (pool cooling down); local:ollama (pool cooling down); nvidia_nim:free-tier (pool cooling down); openrouter:credits (openrouter:free-tier allowance exhausted (account-wide))
...
- **Evidence:** <https://www.submittable.com/solutions/grants>, <https://www.submittable.com/>, <https://impact.submittable.com/platform-grant-management>
...
- **Evidence:** <https://www.foundant.com/products/login/>, <https://platform.softwareone.com/product/foundant-grant-lifecycle-manager-glm/PCP-2211-2472>, <https://philanthropydatasolutions.org/gms-directory/foundant-technologies-grant-lifecycle-manager/>
- **Licence:** `UNKNOWN` (via none (no repository could be attributed to this competitor))
- **Reuse mode:** `clean-room-from-documented-behavior` - no inspectable source (licence UNKNOWN); only publicly documented behaviour may inform our own independent design
- **Idea:** (idea extraction failed) - 
- **Value here:** 
...
### high (1)
- `(purpose)` line 0 (quality-gate) - **Purpose assessment evidence is incomplete**: baseline purpose assessment incomplete: 1/3 sample(s) usable; NotFoundError: Error code: 404 - [{'error': {'code': 404, 'message': 'This model models/gemini-2.5-flash-lite is no longer available to new users. Please update your code to use models/gemini-3.5-flash-lite for the latest features and improvements. We recommend you to use the Interactions API.', 'status': 'NOT_FOUND'}}]; RotationError: no light route available (121 enabled routes in catalog). Pools skipped: gemini:free-tier (pool cooling down); groq:free-tier (pool cooling down); local:ollama (pool cooling down); nvidia_nim:free-tier (pool cooling down); openrouter:credits (openrouter:free-tier allowance exhausted (account-wide)); openrouter:free:cohere/north-mini-code:free (openrouter:free-tier allowance exhausted (account-wide)); final purpose assessment returned no usable result _Suggested fix:_ Retry the resumable run after restoring a responsive provider.
...
| 2 | rotation | budget | RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit exceeded: free-models- | flexfactor.py:2412 |
| 3 | rotation | budget | RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit exceeded: free-models- | flexfactor.py:2412 |
| 4 | rotation | budget | RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit exceeded: free-models- | flexfactor.py:2412 |
| 5 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `open | flexfactor.py:2412 |
| 6 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `qwen | flexfactor.py:2412 |
| 7 | rotation | provider | NotFoundError: Error code: 404 - {'status': 404, 'title': 'Not Found', 'detail': "Function | flexfactor.py:2412 |
| 8 | rotation | provider | APITimeoutError: Request timed out. | flexfactor.py:2412 |
| 9 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `qwen | flexfactor.py:2412 |
| 10 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `open | flexfactor.py:2412 |
...
| 13 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `open | flexfactor.py:2412 |
| 14 | rotation | provider | RuntimeError: Structured output matched no schema key (decoy/unrelated JSON object; expect | flexfactor.py:3048 |
| 15 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `open | flexfactor.py:2412 |
| 16 | rotation | provider | TimeoutError: timed out | flexfactor.py:2755 |
| 17 | rotation | provider | TimeoutError: timed out | flexfactor.py:2755 |
| 18 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `qwen | flexfactor.py:2412 |
...
| 21 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `qwen | flexfactor.py:2412 |
| 22 | rotation | provider | NotFoundError: Error code: 404 - {'status': 404, 'title': 'Not Found', 'detail': "Function | flexfactor.py:2412 |
| 23 | rotation | provider | TimeoutError: timed out | flexfactor.py:2755 |
| 24 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `open | flexfactor.py:2412 |
| 25 | rotation | provider | RuntimeError: Structured output matched no schema key (decoy/unrelated JSON object; expect | flexfactor.py:3048 |
| 26 | rotation | provider | TimeoutError: timed out | flexfactor.py:2755 |
| 27 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `open | flexfactor.py:2412 |
| 28 | rotation | provider | TimeoutError: timed out | flexfactor.py:2755 |
| 29 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `qwen | flexfactor.py:2412 |
| 30 | rotation | provider | TimeoutError: timed out | flexfactor.py:2755 |
| 31 | rotation | provider | JSONDecodeError: Expecting value: line 1 column 1 (char 0) | flexfactor.py:2563 |
| 32 | rotation | provider | TimeoutError: timed out | flexfactor.py:2755 |
| 33 | rotation | budget | APIStatusError: Error code: 402 - {'message': 'Payment required to access this resource. V | flexfactor.py:2412 |
| 34 | rotation | provider | TimeoutError: timed out | flexfactor.py:2755 |
| 35 | baseline | program-defect | baseline publication suite is RED and bounded targeted repair did not fix it | - |
| 36 | rotation | provider | RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit reached for model `met | flexfactor.py:2412 |
| 37 | rotation | provider | NotFoundError: Error code: 404 - [{'error': {'code': 404, 'message': 'This model models/ge | flexfactor.py:2412 |
| 38 | rotation | provider | InternalServerError: Error code: 503 - [{'error': {'code': 503, 'message': 'This model is  | flexfactor.py:2412 |
| 39 | rotation | provider | NotFoundError: Error code: 404 - {'status': 404, 'title': 'Not Found', 'detail': "Function | flexfactor.py:2412 |
| 40 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `open | flexfactor.py:2412 |
| 41 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `open | flexfactor.py:2412 |
| 42 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `qwen | flexfactor.py:2412 |
| 43 | rotation | provider | APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `open | flexfactor.py:2412 |
| 44 | fix | budget | no strong route available (121 enabled routes in catalog). Pools skipped: cerebras:free-ti | src/api/foundations.js |
| 45 | baseline-gate | program-defect | review made no progress: three consecutive semantic review batches completed ZERO files (1 | - |

Counts by kind: budget 6, program-defect 2, provider 37
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `openai/gpt-oss-safeguard-20b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 12885, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `qwen/qwen3.6-27b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 13042, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
NotFoundError: Error code: 404 - {'status': 404, 'title': 'Not Found', 'detail': "Function '5beba52c-65a9-4f46-8cd9-656689a1b205': Not found for account 'hvux_0rjHS6OiBfWXcZvKgoOaUBy_3UsQqq6I6IAz7I'"}
```
...
return client.chat.completions.create(**kwargs)
```
- Route: `nvidia_nim/nvidia/llama-3.1-nemotron-51b-instruct`
...
return client.chat.completions.create(**kwargs)
```
- Route: `nvidia_nim/openai/gpt-oss-120b`
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `qwen/qwen3.8-27b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 13072, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `openai/gpt-oss-20b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 12858, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
NotFoundError: Error code: 404 - {'status': 404, 'title': 'Not Found', 'detail': "Function '9b96341b-9791-4db9-a00d-4e43aa192a39': Not found for account 'hvux_0rjHS6OiBfWXcZvKgoOaUBy_3UsQqq6I6IAz7I'"}
```
...
return client.chat.completions.create(**kwargs)
```
- Route: `nvidia_nim/nvidia/llama-3.1-nemotron-70b-instruct`
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `openai/gpt-oss-120b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 12894, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
RuntimeError: Structured output matched no schema key (decoy/unrelated JSON object; expected one of ['changed', 'edits', 'fixed_titles', 'notes']); len=1033 head='{"type":"object","properties":{"changed":{"type":"boolean","description":"True whenever ANY listed defect was fixed in-file; only false if the file is already correct or literally nothing can be safel'
```
...
raise RuntimeError(
```
- Route: `nvidia_nim/openai/gpt-oss-20b`
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `openai/gpt-oss-safeguard-20b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 22077, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `qwen/qwen3.6-27b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 13005, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
NotFoundError: Error code: 404 - {'status': 404, 'title': 'Not Found', 'detail': "Function '84bf12ff-edbd-4435-baea-0fa6a7453d2e': Not found for account 'hvux_0rjHS6OiBfWXcZvKgoOaUBy_3UsQqq6I6IAz7I'"}
```
...
return client.chat.completions.create(**kwargs)
```
- Route: `nvidia_nim/nvidia/llama-3.1-nemotron-ultra-253b-v1`
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `qwen/qwen3.8-27b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 13039, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
NotFoundError: Error code: 404 - {'status': 404, 'title': 'Not Found', 'detail': "Function '46594287-38b9-481c-a37f-baa02f2d3ba1': Not found for account 'hvux_0rjHS6OiBfWXcZvKgoOaUBy_3UsQqq6I6IAz7I'"}
```
...
return client.chat.completions.create(**kwargs)
```
- Route: `nvidia_nim/nvidia/llama3-chatqa-1.5-70b`
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `openai/gpt-oss-20b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 22220, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
RuntimeError: Structured output matched no schema key (decoy/unrelated JSON object; expected one of ['changed', 'edits', 'fixed_titles', 'notes']); len=227 head='{"type":"object","properties":{"changed":{"type":"boolean"},"edits":{"type":"array"},"fixed_titles":{"type":"array"},"notes":{"type":"string"}},"required":["changed","edits","fixed_titles","notes"],"a'
```
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `openai/gpt-oss-120b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 12858, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `qwen/qwen3.6-27b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 20059, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
✔ enrichment graduates a prospect to qualified (contactable) (2.9743ms)
✔ never prospects the operator's own organizations (dedupe by name/EIN) (2.0379ms)
✔ enrichment runs with bounded concurrency (parallel, not serial) (16.6313ms)
✔ runYanaDiscovery surfaces prospect funnel in the summary (12.6627ms)
✔ YANA_TARGET_AREAS focuses OSM anchors + ProPublica states (owner geographic focus) (3.6312ms)
✔ caller-pinned per-source geography WINS over target areas (1.6551ms)
ℹ tests 3089
ℹ suites 129
ℹ pass 3088
ℹ fail 1
...
ℹ skipped 0
ℹ todo 0
ℹ duration_ms 486812.7042

✖ failing tests:

test at tests\unit\public-source-profile-privacy.test.mjs:209:1
✖ public source tree contains no known real-profile identifier or full-name marker (38245.5824ms)
  ...
  - []
    ...
    code: 'ERR_ASSERTION',
    actual: [ 'grantflow_run_manifest_20260828T103145803956.json:24302: private Windows account or mailbox alias' ],
    expected: [],
...
```
RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit reached for model `meta-llama/llama-4-scout-17b-16e-instruct` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 30000, Used 19666, Requested 23659. Please try again in 26.65s. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'compound', 'code': 'rate_limit_exceeded'}}
```
...
```
NotFoundError: Error code: 404 - [{'error': {'code': 404, 'message': 'This model models/gemini-2.5-flash-lite is no longer available to new users. Please update your code to use models/gemini-3.5-flash-lite for the latest features and improvements. We recommend you to use the Interactions API.', 'status': 'NOT_FOUND'}}]
```
...
This is a 'deep research' product, not a chat model; it can never serve code work through this transport. It is on the unfit list (deep-research); refresh the catalog if it reappears.
...
```
NotFoundError: Error code: 404 - {'status': 404, 'title': 'Not Found', 'detail': "Function '2f495340-a99f-4b4b-89bd-1beb003dd896': Not found for account 'hvux_0rjHS6OiBfWXcZvKgoOaUBy_3UsQqq6I6IAz7I'"}
```
...
return client.chat.completions.create(**kwargs)
```
- Route: `nvidia_nim/google/recurrentgemma-2b`
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `openai/gpt-oss-120b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 12643, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `openai/gpt-oss-20b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 12624, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `qwen/qwen3.8-27b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 12862, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
```
APIStatusError: Error code: 413 - {'error': {'message': 'Request too large for model `openai/gpt-oss-safeguard-20b` in organization `org_01kxhxdkh3e7nasshjpfbkzh11` service tier `on_demand` on tokens per minute (TPM): Limit 8000, Requested 12625, please reduce your message size and try again. Need more tokens? Upgrade to Dev Tier today at https://console.groq.com/settings/billing', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}
```
...
### 45. baseline-gate — program-defect
