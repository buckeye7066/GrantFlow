...
test('every decision includes MATCHER_VERSION 2.0.0', () => {
  ...
  const result = computeMatchDecision(profile, opp)
  assert.equal(result.matcherVersion, '2.0.0', 'matcherVersion should be 2.0.0')
})
