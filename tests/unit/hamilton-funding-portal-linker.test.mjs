/**
 * Unit tests for backend/services/hamilton/studentFundingPortalLinker.js.
 *
 * Tests the classifier rules in the Hamilton spec:
...
} from '../../backend/services/hamilton/studentFundingPortalLinker.js'
...
describe('classifyFundingPortal', () => {
  ...
  it('external marketplace scholarship maps to external_application', () => {
    ...
    assert.ok(c.can_hamilton_attempt === true || c.confidence >= 0.2,
      'Hamilton should at least be allowed to draft external apps')
  })
  ...
  it('unknown opportunity falls back to manual_or_offline + admin review', () => {
    ...
    assert.equal(c.can_hamilton_attempt, false)
  })
