...
export const SECTION_METADATA = {
  ...
  organization_details: {
    ...
    fields: [
      ...
      // Federal Compliance
      { name: "sam_gov_registered", label: "SAM.gov Registered", help: "Required for all federal grants." },
      { name: "grants_gov_account", label: "Grants.gov Account Active", help: "Increases eligibility for federal opportunities." },
      { name: "era_commons_account", label: "eRA Commons Account (NIH/Health Research)", help: "NIH eRA Commons account for health research grants." },
      { name: "sam_exclusions_passed", label: "SAM Exclusions Check Passed", help: "Not debarred from federal contracts." },
      { name: "audited_financials", label: "Audited Financials Available", help: "Audited financial statements available." },
      { name: "nicra_rate", label: "NICRA Indirect Cost Rate (%)", help: "Federally Negotiated Indirect Cost Rate." },
      { name: "ntee_code", label: "NTEE Code", help: "National Taxonomy of Exempt Entities (e.g., A01, B20)." },
      // General Qualifications
      { name: "is_faith_based", label: "Faith-Based Organization / Church / Ministry", help: "True if faith-based organization, church, or ministry." },
      { name: "is_rural_serving", label: "Serves Rural Area", help: "True if serving a rural area." },
      { name: "is_minority_serving", label: "Minority-Serving Organization", help: "True if minority-serving organization." },
      { name: "is_501c3_public_charity", label: "501(c)(3) Public Charity", help: "True if 501(c)(3) public charity." },
      { name: "is_501c3_private_foundation", label: "501(c)(3) Private Foundation", help: "True if 501(c)(3) private foundation." },
      // Business Certifications
      { name: "cert_8a", label: "8(a) Certified", help: "SBA program for disadvantaged businesses." },
      { name: "cert_hubzone", label: "HUBZone Certified", help: "True if HUBZone certified." },
      { name: "cert_sdvosb", label: "Service-Disabled Veteran-Owned Small Business (SDVOSB)", help: "True if SDVOSB certified." },
      { name: "cert_mbe", label: "Minority Business Enterprise (MBE)", help: "True if MBE certified." },
      { name: "cert_wbe", label: "Women Business Enterprise (WBE)", help: "True if WBE certified." },
      { name: "cert_sbir_sttr", label: "SBIR/STTR Eligible", help: "True if eligible for SBIR/STTR programs." },
      // Geographic & Special Designations
      { name: "in_opportunity_zone", label: "Opportunity Zone Location", help: "Economically distressed community eligible for tax incentives." },
      { name: "in_qct", label: "Qualified Census Tract (QCT)", help: "HUD-designated low-income area." },
      { name: "in_epa_ej_area", label: "EPA Environmental Justice Area", help: "True if located in an EPA Environmental Justice area." },
      { name: "in_usda_persistent_poverty_county", label: "USDA Persistent-Poverty County", help: "True if located in a USDA persistent-poverty county." },
      { name: "in_appalachian_region", label: "Appalachian Region", help: "Served by Appalachian Regional Commission." },
      { name: "broadband_unserved", label: "Broadband-Unserved (FCC Map Block)", help: "No high-speed internet — USDA ReConnect and NTIA grants." },
      { name: "in_fema_disaster_area", label: "FEMA Disaster Declaration Area", help: "True if located in a FEMA disaster declaration area." },
      // Specialized Org Types
      { name: "is_tribal_government", label: "Tribal Government / Tribally Controlled Organization", help: "True if tribal government or tribally controlled organization." },
      { name: "is_community_action_agency", label: "Community Action Agency (CAA)", help: "CSBG eligible entity." },
      { name: "is_housing_authority", label: "Housing Authority", help: "True if housing authority." },
      { name: "is_workforce_dev_board", label: "Workforce Development Board", help: "True if workforce development board." },
      { name: "is_cdfi", label: "CDFI Partner", help: "Community Development Financial Institution." },
      { name: "is_msi_hbcu", label: "MSI/HBCU/HSI/TCU", help: "Minority-Serving Institution." },
      { name: "is_rural_health_clinic", label: "Rural Health Clinic (RHC)", help: "True if rural health clinic." },
      { name: "is_cooperative", label: "Cooperative (Ag/Electric/Housing/Worker)", help: "True if cooperative organization." },
    ],
  },
  ...
  financial_information: {
    ...
    fields: [
      ...
      { name: "underemployed", label: "Underemployed", help: "Working part-time or below skill level." },
      { name: "has_medical_debt", label: "Medical Debt", help: "Outstanding medical bills — debt relief programs available." },
      { name: "has_education_debt", label: "Education/Student Loan Debt", help: "Student loan forgiveness programs available." },
      { name: "bankruptcy_foreclosure", label: "Bankruptcy / Foreclosure", help: "Recent financial crisis — recovery assistance available." },
      { name: "first_time_homebuyer", label: "First-Time Homebuyer", help: "Down payment assistance programs available." },
    ],
  },
  ...
  demographics: {
    ...
    fields: [
      ...
      { name: "good_credit_score", label: "Good Credit Score (700+)", help: "Qualifies for financial literacy programs and non-loan support." },
      { name: "religious_denomination", label: "Religious Denomination", help: "e.g., Baptist, Methodist, Catholic, Lutheran — denominational scholarships available." },
      { name: "jewish_heritage", label: "Jewish Heritage", help: "Extensive funding from Jewish federations, Hillel, and synagogues." },
      { name: "irish_heritage", label: "Irish Heritage", help: "Hibernian societies, Irish cultural organizations." },
      { name: "italian_heritage", label: "Italian Heritage", help: "True if Italian heritage." },
      { name: "greek_heritage", label: "Greek Heritage", help: "AHEPA, Hellenic societies." },
      { name: "armenian_heritage", label: "Armenian Heritage", help: "True if Armenian heritage." },
      { name: "appalachian_heritage", label: "Appalachian Heritage", help: "True if Appalachian heritage." },
    ],
  },
  ...
  education: {
    ...
    fields: [
      ...
      { name: "pell_grant_eligible", label: "Pell Grant Eligible", help: "Federal grant for low-income students." },
      { name: "fafsa_completed", label: "FAFSA Completed", help: "Required for most federal financial aid." },
      { name: "first_generation_college_student", label: "First-Generation College Student", help: "First in your family to attend college." },
      { name: "dual_enrollment", label: "Dual Enrollment / Early College", help: "True if enrolled in dual enrollment or early college program." },
      { name: "rotc_jrotc", label: "ROTC / JROTC Participation", help: "Military training — ROTC scholarships available." },
      { name: "cte_pathway", label: "CTE Pathway", help: "Career/Technical Education (EMT, welding, cybersecurity, nursing, etc.)." },
      { name: "honor_societies", label: "Honor Societies", help: "NHS, Phi Theta Kappa, etc." },
      { name: "efc_sai_band", label: "EFC/SAI Band", help: "Expected Family Contribution / Student Aid Index." },
    ],
  },
