...
export function canonicalResultShape() {
  return {
    ...
    amount_text: 'string?',
    amount_status: 'known|estimated|range|varies|not_listed|contact_required|none_published?',
    ...
    missing_eligibility_fields: 'string[]',
    eligibility_evidence: 'prose|structured_flags|applicant_types_only|none|unknown',
    geo_evidence: 'national|stated|unknown',
