        ...
        <body>
          ...
          <div class="invoice-info">
            ...
            <div>
              ...
              <div class="section-value">${account.profile_name}</div>
              <div class="section-title">Profile Type</div>
              <div class="section-value">${account.profile_type?.replace(/_/g, ' ') || 'N/A'}</div>
            </div>
          </div>
          ...
          <table class="details-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>${form.discount_type.charAt(0).toUpperCase() + form.discount_type.slice(1)} (${form.discount_percent}%)</td>
              ...
              <tr>
                <td colspan="3">
                  ...
                  ${form.pro_bono_reason ? `<div style="margin-top: 8px; color: #6b7280;">${form.pro_bono_reason}</div>` : ''}
                </td>
              </tr>
              ` : ''}
              <tr class="total-row">
