...
- **Original file**: `G:\One Drive\Desktop\Payment sheet Grantflow.pdf` (user-provided)
- **Document title**: GrantFlow Professional Grant Writing Services – Master Service Menu
- **Date**: 11/13/2025

> Note: This file is a **text extract** of the PDF for repo tracking, testing, and drift detection.
> The binary PDF should be committed separately by the repo owner if desired.
