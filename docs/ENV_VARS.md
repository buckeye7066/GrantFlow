...
- Total vars: **937**
- Vars referenced in code: **936**
- Vars listed in env templates: **934**
...
- **Templates**:
  - `.env.example:40` = `admin@example.invalid`
...
- **Templates**:
  - `.env.example:48` = `http://127.0.0.1:8080`
...
- **Code references**:
  ...
  - `backend/server.js:L187–L1966` (process.env)
...
- **Code references**:
  ...
  - `backend/server.js:L1839` (process.env)
...
- **Code references**:
  - `backend/tests/enforceInvariants.test.js:L5146–L5150` (process.env)
...
- **Code references**:
  - `backend/routes/admin.js:L730` (process.env)
  - `backend/routes/ai.js:L219–L771` (process.env)
  - `backend/routes/nofo.js:L278` (process.env)
  - `backend/routes/profiles.js:L3736–L3930` (process.env)
...
- **Code references**:
  - `backend/routes/admin.js:L610` (process.env)
  - `backend/routes/ai.js:L134` (process.env)
  - `backend/routes/anya.js:L173` (process.env)
  - `backend/routes/nofo.js:L43` (process.env)
...
- **Code references**:
  - `backend/routes/admin.js:L609` (process.env)
...
- **Code references**:
  - `backend/routes/admin.js:L5593` (process.env)
...
- **Code references**:
  - `backend/server.js:L4205` (process.env)
...
- **Code references**:
  - `backend/routes/profiles.js:L4370` (process.env)
...
- **Code references**:
  - `backend/routes/auth.js:L204` (process.env)
  - `backend/server.js:L270–L766` (process.env)
...
- **Code references**:
  ...
  - `backend/server.js:L1647–L1963` (process.env)
...
- **Code references**:
  - `backend/server.js:L3758` (process.env)
...
- **Code references**:
  - `backend/server.js:L1398` (process.env)
...
- **Templates**:
  ...
  - `backend/.env.example:180` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  ...
  - `backend/.env.example:181` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  ...
  - `backend/.env.example:189` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  ...
  - `backend/.env.example:193` = `<REPLACE_ME>`
- **Code references**:
  - `backend/server.js:L3230` (process.env)
...
- **Templates**:
  - `.env.example:226` = ``
  - `backend/.env.example:196` = ``
- **Code references**:
  - `backend/server.js:L2864` (process.env)

### `BULK_POPULATE_KEY`

- **Templates**:
  - `.env.example:227` = `<REPLACE_ME>`
  - `backend/.env.example:197` = `<REPLACE_ME>`
- **Code references**:
  ...
  - `backend/server.js:L1689–L1967` (process.env)
...
- **Code references**:
  ...
  - `backend/server.js:L2516` (process.env)
...
- **Templates**:
  - `.env.example:243` = `<REPLACE_ME>`
  - `backend/.env.example:213` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:284` = `http://127.0.0.1:8080`
  - `backend/.env.example:254` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:285` = `postgres://USER:PASSWORD@HOST:5432/DBNAME`
  - `backend/.env.example:255` = `postgres://USER:PASSWORD@HOST:5432/DBNAME`
- **Code references**:
...
- **Templates**:
  - `.env.example:290` = `sqlite`
  - `backend/.env.example:260` = `sqlite`
- **Code references**:
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L4743` (process.env)
...
- **Templates**:
  - `.env.example:295` = `http://127.0.0.1:8080`
  - `backend/.env.example:265` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Code references**:
  - `backend/routes/admin.js:L5591` (process.env)
...
- **Templates**:
  - `.env.example:299` = `<REPLACE_ME>`
  - `backend/.env.example:269` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  - `backend/server.js:L1494` (process.env)
...
- **Templates**:
  - `.env.example:307` = `http://127.0.0.1:8080`
  - `backend/.env.example:277` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:308` = `8080`
  - `backend/.env.example:278` = `8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:312` = `<REPLACE_ME>`
  - `backend/.env.example:282` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  - `backend/server.js:L1507` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5532` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5145–L5231` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L6218` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5856–L5896` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L8727` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/enforceInvariants.test.js:L4441–L4455` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5849` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5317–L5378` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L6355` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5557–L5606` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L7855` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L6510` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5318–L6056` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L9134` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/enforceInvariants.test.js:L5010–L5019` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/enforceInvariants.test.js:L4613–L4719` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5231` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L6979` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5319–L5478` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L7365` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/enforceInvariants.test.js:L4867–L4874` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L6669` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L6819` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5362` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5066` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L7592` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L8131` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L8280` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5917` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5678–L5737` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L8441` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L7179` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L6092` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5765–L5795` (process.env)
...
- **Templates**:
  ...
  - `backend/.env.example:350` = `http://127.0.0.1:8080`
- **Code references**:
  - `backend/routes/auth.js:L202` (process.env)
  - `backend/services/diagnosticsService.js:L416` (process.env)
...
- **Templates**:
  - `.env.example:382` = `http://127.0.0.1:8080`
  - `backend/.env.example:352` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Code references**:
  - `backend/routes/admin.js:L97–L2246` (process.env)
...
- **Templates**:
  - `.env.example:403` = `<REPLACE_ME>`
  - `backend/.env.example:373` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:404` = `<REPLACE_ME>`
  - `backend/.env.example:374` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:415` = `<REPLACE_ME>`
  - `backend/.env.example:385` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  ...
  - `backend/server.js:L2515` (process.env)
...
- **Code references**:
  - `backend/server.js:L586` (process.env)
...
- **Code references**:
  - `backend/server.js:L585` (process.env)
...
- **Templates**:
  ...
  - `backend/.env.example:392` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:424` = `<REPLACE_ME>`
  - `backend/.env.example:394` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  ...
  - `backend/.env.example:396` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:436` = `http://127.0.0.1:8080`
  - `backend/.env.example:406` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:439` = `http://127.0.0.1:8080`
...
- **Templates**:
  - `.env.example:444` = `http://127.0.0.1:8080`
...
- **Templates**:
  - `.env.example:445` = `http://127.0.0.1:8080`
  - `backend/.env.example:415` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  ...
  - `backend/.env.example:421` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Code references**:
  ...
  - `backend/server.js:L1050` (process.env)

### `GRANTFLOW_SKIP_VERIFICATION_GATE`

- **Templates**:
  - `.env.example:453` = ``
  - `backend/.env.example:423` = ``
- **Code references**:
...
- **Templates**:
  - `.env.example:456` = `<REPLACE_ME>`
  - `backend/.env.example:426` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:459` = `<REPLACE_ME>`
  - `backend/.env.example:429` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:460` = `<REPLACE_ME>`
  - `backend/.env.example:430` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  - `backend/server.js:L3997` (process.env)
...
- **Code references**:
  - `backend/server.js:L3092` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/enforceInvariants.test.js:L602–L5493` (process.env)
...
- **Templates**:
  - `.env.example:515` = `http://127.0.0.1:8080`
  - `backend/.env.example:485` = `http://127.0.0.1:8080`
- **Code references**:
  - `backend/services/anyaAdminTools.js:L1330` (process.env)
...
- **Templates**:
  - `.env.example:516` = `http://127.0.0.1:8080`
  - `backend/.env.example:486` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:524` = `<REPLACE_ME>`
  - `backend/.env.example:494` = `<REPLACE_ME>`
- **Code references**:
  - `backend/routes/blocklist.js:L35` (process.env)
  - `backend/routes/emailGrants.js:L31` (process.env)
...
- **Templates**:
  - `.env.example:531` = `Annie | GrantFlow`
  - `backend/.env.example:501` = `Annie | GrantFlow`
- **Code references**:
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5624` (process.env)
...
- **Templates**:
  - `.env.example:535` = `Annie@axiombiolabs.org`
  - `backend/.env.example:505` = `Annie@axiombiolabs.org`
- **Code references**:
...
- **Templates**:
  - `.env.example:545` = `dr.johnwhite@axiombiolabs.org`
  - `backend/.env.example:515` = `dr.johnwhite@axiombiolabs.org`
- **Code references**:
...
- **Templates**:
  - `.env.example:547` = `Annie@axiombiolabs.org`
  - `backend/.env.example:517` = `Annie@axiombiolabs.org`
- **Code references**:
...
- **Templates**:
  - `.env.example:566` = `<REPLACE_ME>`
  - `backend/.env.example:536` = `<REPLACE_ME>`
- **Code references**:
  - `tools/laptop-connector/capture.js:L146` (process.env)
  - `tools/laptop-connector/scan.js:L102` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5677` (process.env)
...
- **Code references**:
  - `backend/server.js:L3835–L3938` (process.env)
...
- **Code references**:
  - `backend/server.js:L3833` (process.env)
...
- **Code references**:
  - `backend/tests/enforceInvariants.test.js:L5959–L5977` (process.env)
...
- **Templates**:
  - `.env.example:597` = `<REPLACE_ME>`
  - `backend/.env.example:567` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  - `backend/server.js:L1503` (process.env)
...
- **Templates**:
  - `.env.example:606` = `http://127.0.0.1:8080`
  - `backend/.env.example:576` = `http://127.0.0.1:8080`
- **Code references**:
  - `scripts/build-mobile-bundle.mjs:L31` (process.env)
...
- **Code references**:
  - `backend/server.js:L4041` (process.env)
...
- **Code references**:
  - `backend/server.js:L4341` (process.env)
...
- **Code references**:
  - `backend/server.js:L4343` (process.env)
...
- **Code references**:
  - `backend/server.js:L4347` (process.env)
...
- **Code references**:
  - `backend/server.js:L4346` (process.env)
...
- **Code references**:
  - `backend/server.js:L4080` (process.env)
...
- **Code references**:
  ...
  - `backend/routes/admin.js:L3606–L5591` (process.env)
  - `backend/routes/anya.js:L147–L222` (process.env)
  - `backend/routes/auth.js:L221–L3374` (process.env)
  - `backend/routes/grants.js:L2660–L2763` (process.env)
  - `backend/routes/health.js:L80–L464` (process.env)
  - `backend/routes/nofo.js:L325–L522` (process.env)
  ...
  - `backend/server.js:L201–L4333` (process.env)
...
- **Code references**:
  - `backend/routes/nofo.js:L69` (process.env)
...
- **Templates**:
  - `.env.example:633` = `<REPLACE_ME>`
  - `backend/.env.example:603` = `<REPLACE_ME>`
- **Code references**:
  - `backend/routes/admin.js:L857–L1345` (process.env)
...
- **Code references**:
  ...
  - `backend/routes/nofo.js:L31` (process.env)
  - `backend/routes/profiles.js:L3692–L3903` (process.env)
...
- **Templates**:
  - `.env.example:637` = `http://127.0.0.1:8080`
  - `backend/.env.example:607` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:648` = `5432`
  - `backend/.env.example:618` = `5432`
- **Code references**:
...
- **Code references**:
  - `backend/server.js:L4131` (process.env)
...
- **Code references**:
  - `backend/middleware/pipelineMonitor.js:L16` (process.env)
...
- **Code references**:
  - `backend/server.js:L2389` (process.env)
...
- **Templates**:
  - `.env.example:665` = `8080`
  - `backend/.env.example:635` = `8080`
- **Code references**:
  - `backend/routes/sam.js:L164` (process.env)
  - `backend/server.js:L225–L3629` (process.env)
  - `backend/services/anyaAdminTools.js:L1332` (process.env)
...
- **Templates**:
  - `.env.example:672` = `<REPLACE_ME>`
  - `backend/.env.example:642` = `<REPLACE_ME>`
- **Code references**:
  - `backend/db/index.js:L38` (process.env)
...
- **Templates**:
  - `.env.example:673` = `8080`
  - `backend/.env.example:643` = `8080`
- **Code references**:
  - `backend/db/index.js:L36` (process.env)
...
- **Templates**:
  - `.env.example:675` = `8080`
  - `backend/.env.example:645` = `8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:688` = `http://127.0.0.1:8080`
  - `backend/.env.example:658` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:709` = `http://127.0.0.1:8080`
  - `backend/.env.example:679` = `http://127.0.0.1:8080`
- **Code references**:
  - `backend/services/stripeService.js:L100` (process.env)
...
- **Templates**:
  - `.env.example:710` = `http://127.0.0.1:8080`
  - `backend/.env.example:680` = `http://127.0.0.1:8080`
- **Code references**:
  - `backend/routes/auth.js:L201` (process.env)
...
- **Code references**:
  - `backend/server.js:L3503` (process.env)
...
- **Code references**:
  - `backend/server.js:L3502` (process.env)
...
- **Code references**:
  - `backend/server.js:L3508` (process.env)
...
- **Code references**:
  - `backend/server.js:L3507` (process.env)
...
- **Code references**:
  - `backend/server.js:L2865` (process.env)
...
- **Code references**:
  ...
  - `backend/server.js:L23–L2514` (process.env)
...
- **Templates**:
  ...
  - `backend/.env.example:694` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:732` = `http://127.0.0.1:8080`
  - `backend/.env.example:702` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:735` = `<REPLACE_ME>`
  - `backend/.env.example:705` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L8126–L8129` (process.env)

### `ROBERT_ADMIN_TOKEN`

- **Templates**:
  - `.env.example:737` = `<REPLACE_ME>`
  - `backend/.env.example:707` = `<REPLACE_ME>`
- **Code references**:
  - `backend/routes/robert.js:L63` (process.env)
...
- **Templates**:
  - `.env.example:776` = `http://127.0.0.1:8080`
  - `backend/.env.example:746` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:787` = `<REPLACE_ME>`
  - `backend/.env.example:757` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:789` = `<REPLACE_ME>`
  - `backend/.env.example:759` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:790` = `<REPLACE_ME>`
  - `backend/.env.example:760` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  - `backend/server.js:L4161` (process.env)
...
- **Templates**:
  - `.env.example:803` = `http://127.0.0.1:8080`
  - `backend/.env.example:773` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5223` (process.env)
...
- **Templates**:
  - `.env.example:820` = `http://127.0.0.1:8080`
...
- **Code references**:
  - `backend/routes/admin.js:L3582` (process.env)
...
- **Templates**:
  - `.env.example:826` = `<REPLACE_ME>`
  - `backend/.env.example:796` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  - `backend/server.js:L3073` (process.env)

### `SIMPLER_GRANTS_API_KEY`

- **Templates**:
  - `.env.example:835` = `<REPLACE_ME>`
  - `backend/.env.example:805` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:841` = `http://127.0.0.1:8080`
  - `backend/.env.example:811` = `http://127.0.0.1:8080`
- **Code references**:
  - `scripts/dedupe-profiles.mjs:L28` (process.env)
...
- **Templates**:
  - `.env.example:859` = `backend/data/grantflow.dev.db`
  - `backend/.env.example:829` = `backend/data/grantflow.dev.db`
- **Code references**:
...
- **Code references**:
  - `backend/server.js:L1434` (process.env)
...
- **Code references**:
  - `backend/server.js:L3654` (process.env)
...
- **Templates**:
  - `.env.example:871` = `<REPLACE_ME>`
  - `backend/.env.example:841` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:872` = `http://127.0.0.1:8080`
  - `backend/.env.example:842` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:876` = `<REPLACE_ME>`
  - `backend/.env.example:846` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:877` = `<REPLACE_ME>`
  - `backend/.env.example:847` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  ...
  - `backend/server.js:L2517` (process.env)
  - `backend/services/productionAuditSnapshot.js:L440` (process.env)
...
- **Templates**:
  - `.env.example:901` = `<REPLACE_ME>`
  - `backend/.env.example:871` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:902` = `http://127.0.0.1:8080`
...
- **Templates**:
  ...
  - `backend/.env.example:873` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:910` = `http://127.0.0.1:8080`
  - `backend/.env.example:880` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:27` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Code references**:
  - `backend/server.js:L3937` (process.env)

### `X_ADMIN_TOKEN`

- **Templates**:
  - `.env.example:930` = `<REPLACE_ME>`
  - `backend/.env.example:900` = `<REPLACE_ME>`
- **Code references**:
  - `scripts/smoke-docs-local.mjs:L18` (process.env)
...
- **Code references**:
  - `backend/server.js:L3212` (process.env)
...
- **Templates**:
  - `.env.example:948` = `Bradley County, TN; Lorain County, OH; Erie County, OH`
  - `backend/.env.example:918` = `Bradley County, TN; Lorain County, OH; Erie County, OH`
- **Code references**:
...
- **Templates**:
  - `.env.example:949` = `http://127.0.0.1:8080`
  - `backend/.env.example:919` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:950` = `http://127.0.0.1:8080`
  - `backend/.env.example:920` = `http://127.0.0.1:8080`
- **Code references**:
