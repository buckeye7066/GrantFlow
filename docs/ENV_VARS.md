...
| `ANYA_FLEET_CRAWL_MIN_INTERVAL_MS` | Yes | Yes | Backend/Node |
...
| `BACKUP_DIR` | Yes | Yes | Backend/Node |
| `BACKUP_KEEP` | Yes | Yes | Backend/Node |
| `BACKUP_MAX_AGE_HOURS` | Yes | Yes | Backend/Node |
...
| `CATALOG_RESCORE_EXPLAIN_TIME_BUDGET_MS` | Yes | Yes | Backend/Node |
...
| `CLAMAV_HOST` | Yes | Yes | Backend/Node |
| `CLAMAV_PORT` | Yes | Yes | Backend/Node |
| `CLAMAV_REQUIRED` | Yes | Yes | Backend/Node |
| `CLAMAV_TIMEOUT_MS` | Yes | Yes | Backend/Node |
...
| `ENFORCE_STALE_MATCH_EXPLAIN` | Yes | Yes | Backend/Node |
...
| `ERROR_REPORT_LLM_ANALYSIS_ENABLED` | Yes | Yes | Backend/Node |
...
| `GLOBAL_API_RATE_LIMIT_MAX` | Yes | Yes | Backend/Node |
| `GLOBAL_API_RATE_LIMIT_WINDOW_MS` | Yes | Yes | Backend/Node |
...
| `GRANTFLOW_SOFT_RELEVANCE_PENALTY` | Yes | Yes | Backend/Node |
...
| `MOBILE_MIN_NATIVE_VERSION` | Yes | Yes | Backend/Node |
| `MOBILE_UPDATE_BASE_URL` | Yes | Yes | Backend/Node |
...
| `NATIONWIDE_BATCH_SIZE` | Yes | Yes | Backend/Node |
| `NATIONWIDE_MIN_SOURCES_PER_ZIP` | Yes | Yes | Backend/Node |
| `NATIONWIDE_RATE_LIMIT_MS` | Yes | Yes | Backend/Node |
...
| `NOFO_PARSE_CHUNK_CHARS` | Yes | Yes | Backend/Node |
...
| `PROFILE_SCORING_MAX_CANDIDATES` | Yes | Yes | Backend/Node |
| `PROFILE_TAXONOMY_DEBUG` | Yes | Yes | Backend/Node |
| `PROMOPILOT_ATTRIBUTION_SECRET` | Yes | Yes | Backend/Node |
| `PROMOPILOT_ATTRIBUTION_URL` | Yes | Yes | Backend/Node |
...
| `SOURCE_FAILURE_WINDOW_HOURS` | Yes | Yes | Backend/Node |
...
| `STALE_MATCH_EXPLAIN_PAIR_BUDGET` | Yes | Yes | Backend/Node |
| `STALE_MATCH_EXPLAIN_TIME_BUDGET_MS` | Yes | Yes | Backend/Node |
...
- **Templates**:
  - `.env.example:39` = `admin@example.invalid`
...
- **Code references**:
  ...
  - `backend/server.js:L211` (process.env)
...
- **Code references**:
  - `backend/routes/adminCrawlCoverageActions.js:L50` (process.env)
...
- **Code references**:
  - `backend/server.js:L210` (process.env)
...
- **Code references**:
  - `backend/services/anyaAutonomousCrawler.js:L719` (process.env)
  - `backend/services/anyaAutonomousFunctionRunner.js:L129–L527` (process.env)
...
- **Code references**:
  - `backend/db/index.js:L798` (process.env)
  ...
  - `backend/server.js:L321` (process.env)
...
- **Code references**:
  - `backend/routes/health.js:L415` (process.env)
...
- **Code references**:
  ...
  - `backend/server.js:L1849` (process.env)
...
- **Code references**:
  - `backend/routes/auth.js:L508` (process.env)
...
- **Code references**:
  - `backend/db/index.js:L749` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L3669–L4119` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L3975–L4441` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L3668` (process.env)
...
- **Code references**:
  - `backend/services/amy/amyAgent.js:L237` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/amyApprovalLedger.test.js:L104–L130` (process.env)
...
- **Code references**:
  - `backend/tests/enforceInvariants.test.js:L5186–L5190` (process.env)
...
- **Templates**:
  - `.env.example:102` = `<REPLACE_ME>`
  - `backend/.env.example:73` = `<REPLACE_ME>`
- **Code references**:
  - `backend/routes/admin.js:L649–L652` (process.env)
  - `backend/routes/ai.js:L128–L132` (process.env)
  - `backend/routes/anya.js:L150–L215` (process.env)
  - `backend/routes/nofo.js:L133–L136` (process.env)
  - `backend/routes/profiles.js:L601–L605` (process.env)
  - `backend/services/anyaOrchestrator.js:L39` (process.env)
  - `backend/services/diagnosticsService.js:L407` (process.env)
  - `backend/services/documentIngestion.js:L73–L952` (process.env)
  - `backend/services/errorReporter.js:L170` (process.env)
  ...
  - `backend/tests/nofoDurableUploadRoute.test.js:L49` (process.env)
...
- **Code references**:
  - `backend/routes/admin.js:L860` (process.env)
  - `backend/routes/ai.js:L219–L771` (process.env)
  - `backend/routes/nofo.js:L262` (process.env)
  - `backend/routes/profiles.js:L3779–L3973` (process.env)
  - `backend/services/anyaAdversarialRepairLoop.js:L295` (process.env)
  - `backend/services/anyaOrchestrator.js:L64–L1688` (process.env)
  - `backend/services/documentIngestion.js:L1012` (process.env)
  - `backend/services/errorReporter.js:L247` (process.env)
...
- **Code references**:
  - `backend/routes/ai.js:L2184` (process.env)
...
- **Code references**:
  - `backend/routes/admin.js:L654` (process.env)
  - `backend/routes/ai.js:L134` (process.env)
  - `backend/routes/anya.js:L173` (process.env)
  - `backend/routes/nofo.js:L138` (process.env)
  - `backend/routes/profiles.js:L607` (process.env)
...
- **Code references**:
  - `backend/routes/admin.js:L653` (process.env)
  - `backend/routes/ai.js:L133` (process.env)
  - `backend/routes/anya.js:L172` (process.env)
  - `backend/routes/nofo.js:L137` (process.env)
...
- **Code references**:
  - `backend/routes/admin.js:L5762` (process.env)
  - `backend/services/anyaAutonomousCrawler.js:L778` (process.env)
...
- **Code references**:
  - `backend/server.js:L4239` (process.env)
...
### `ANYA_FLEET_CRAWL_MIN_INTERVAL_MS`

- **Templates**:
  - `.env.example:135` = ``
  - `backend/.env.example:106` = ``
- **Code references**:
  - `backend/tests/autonomousFleetCrawlAdmission.test.js:L79–L166` (process.env)
...
- **Code references**:
  - `backend/routes/auth.js:L2768` (process.env)
...
- **Templates**:
  - `.env.example:161` = `http://127.0.0.1:8080`
  - `backend/.env.example:132` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Code references**:
  - `backend/services/sam/samRegistry.js:L2205` (process.env)
...
- **Templates**:
  - `.env.example:166` = `http://127.0.0.1:8080`
  - `backend/.env.example:137` = `http://127.0.0.1:8080`
- **Code references**:
  ...
  - `tests/smoke/axe-utils.mjs:L51` (process.env)
  - `tests/smoke/playwright.config.mjs:L4` (process.env)

### `API_DATA_GOV_KEY`

- **Templates**:
  - `.env.example:167` = `<REPLACE_ME>`
  - `backend/.env.example:138` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:168` = `http://127.0.0.1:8080`
  - `backend/.env.example:139` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Code references**:
  - `backend/routes/profiles.js:L4413` (process.env)
...
- **Code references**:
  - `backend/routes/auth.js:L2506–L3413` (process.env)
...
- **Templates**:
  - `.env.example:181` = ``
  - `backend/.env.example:152` = ``
- **Code references**:
  - `backend/routes/auth.js:L204` (process.env)
  - `backend/server.js:L275–L776` (process.env)

### `AUTH_FRONTEND_URL`

- **Templates**:
  - `.env.example:182` = `http://127.0.0.1:8080`
  - `backend/.env.example:153` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:183` = `<REPLACE_ME>`
  - `backend/.env.example:154` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:187` = `<REPLACE_ME>`
  - `backend/.env.example:158` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:193` = `http://127.0.0.1:8080`
  - `backend/.env.example:164` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:196` = `<REPLACE_ME>`
  - `backend/.env.example:167` = `<REPLACE_ME>`
- **Code references**:
  - `backend/scripts/check-crawler-results.mjs:L25` (process.env)
...
- **Code references**:
  - `backend/server.js:L3792` (process.env)
...
- **Code references**:
  - `backend/apply/applyEngine.js:L1423` (process.env)

### `AUTO_POPULATE_TOTAL_BUDGET_MS`

- **Templates**:
  - `.env.example:200` = ``
  - `backend/.env.example:171` = ``
- **Code references**:
  - `backend/apply/applyEngine.js:L1426` (process.env)

### `AWS_ACCESS_KEY_ID`

- **Templates**:
  - `.env.example:201` = `<REPLACE_ME>`
  - `backend/.env.example:172` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  ...
  - `backend/.env.example:176` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:206` = `http://127.0.0.1:8080`
  - `backend/.env.example:177` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Code references**:
  - `backend/services/ops/databaseBackup.js:L43` (process.env)
...
- **Code references**:
  - `backend/services/ops/databaseBackup.js:L39` (process.env)
...
- **Code references**:
  - `backend/services/sam/samRegistry.js:L2665` (process.env)
...
- **Code references**:
  - `backend/server.js:L1408` (process.env)
  - `backend/startup/selfHeal.js:L99` (process.env)
  - `backend/tests/selfHealObservability.test.js:L38–L43` (process.env)

### `BASE_URL`

- **Templates**:
  - `.env.example:212` = `http://127.0.0.1:8080`
  - `backend/.env.example:183` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:213` = `<REPLACE_ME>`
  - `backend/.env.example:184` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  - `backend/services/billing/invoiceService.js:L265` (process.env)
...
- **Templates**:
  - `.env.example:217` = ``
  - `backend/.env.example:188` = ``
- **Code references**:
  - `backend/server.js:L3904` (process.env)
...
- **Code references**:
  - `backend/services/billing/invoiceService.js:L36–L287` (process.env)

### `BLOCKLIST_INGEST_TOKEN`

- **Templates**:
  - `.env.example:221` = `<REPLACE_ME>`
...
- **Templates**:
  - `.env.example:225` = `<REPLACE_ME>`
  - `backend/.env.example:196` = `<REPLACE_ME>`
- **Code references**:
  - `backend/server.js:L3264` (process.env)
  ...
  - `backend/tests/gfBatch05PurposeGuards.test.js:L65–L73` (process.env)
...
- **Code references**:
  - `backend/routes/version.js:L44` (process.env)
...
- **Code references**:
  - `backend/server.js:L2898` (process.env)

### `BULK_POPULATE_KEY`

- **Templates**:
  - `.env.example:229` = `<REPLACE_ME>`
  - `backend/.env.example:200` = `<REPLACE_ME>`
- **Code references**:
  ...
  - `backend/server.js:L1699–L1986` (process.env)
  - `tests/unit/authIdentity.test.mjs:L93–L162` (process.env)

### `CATALOG_RESCORE_EXPLAIN_TIME_BUDGET_MS`

- **Templates**:
  - `.env.example:230` = ``
  - `backend/.env.example:201` = ``
- **Code references**:
  - `backend/services/matching/catalogRescoreSweep.js:L237` (process.env)
...
- **Code references**:
  - `backend/services/matching/catalogRescoreSweep.js:L228` (process.env)
...
- **Code references**:
  - `backend/services/matching/catalogRescoreSweep.js:L230` (process.env)
...
- **Code references**:
  - `backend/routes/health.js:L123` (process.env)
  - `backend/utils/uploadFileValidation.js:L153` (process.env)

### `CLAMAV_PORT`

- **Templates**:
  - `.env.example:236` = `3310`
  - `backend/.env.example:207` = `3310`
- **Code references**:
  - `backend/utils/uploadFileValidation.js:L154` (process.env)

### `CLAMAV_REQUIRED`

- **Templates**:
  - `.env.example:237` = `false`
  - `backend/.env.example:208` = `false`
- **Code references**:
  - `backend/routes/health.js:L124` (process.env)
  - `backend/utils/uploadFileValidation.js:L155` (process.env)

### `CLAMAV_TIMEOUT_MS`

- **Templates**:
  - `.env.example:238` = `10000`
  - `backend/.env.example:209` = `10000`
- **Code references**:
  - `backend/utils/uploadFileValidation.js:L156` (process.env)
...
- **Code references**:
  - `backend/routes/health.js:L74–L593` (process.env)
  - `backend/server.js:L2550` (process.env)
...
- **Templates**:
  - `.env.example:249` = `<REPLACE_ME>`
  - `backend/.env.example:220` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  - `backend/services/connectorIngestService.js:L493` (process.env)
...
- **Code references**:
  - `backend/services/sam/samRegistry.js:L2750` (process.env)
...
- **Code references**:
  - `backend/services/sam/samRegistry.js:L2759` (process.env)
...
- **Code references**:
  - `backend/services/crawlerDispatcher.js:L224` (process.env)
...
- **Code references**:
  - `backend/services/crawlerDispatcher.js:L220` (process.env)
...
- **Code references**:
  - `backend/services/crawlerDispatcher.js:L225` (process.env)
...
- **Templates**:
  - `.env.example:281` = ``
  - `backend/.env.example:252` = ``
- **Code references**:
  - `backend/services/sam/samRegistry.js:L2825` (process.env)
  - `backend/startup/enforceInvariants.js:L4567` (process.env)

### `CRAWLER_STALE_CLEANUP_INTERVAL_MS`

- **Templates**:
  - `.env.example:282` = ``
  - `backend/.env.example:253` = ``
- **Code references**:
...
- **Code references**:
  - `backend/routes/crawlerV2.js:L45` (process.env)
...
- **Code references**:
  ...
  - `backend/services/sam/samRegistry.js:L2702` (process.env)
...
- **Templates**:
  - `.env.example:290` = `http://127.0.0.1:8080`
  - `backend/.env.example:261` = `http://127.0.0.1:8080`
- **Code references**:
  - `backend/scripts/migrate-sqlite-to-postgres.mjs:L325` (process.env)

### `DATABASE_URL`

- **Templates**:
  - `.env.example:291` = `postgres://USER:PASSWORD@HOST:5432/DBNAME`
  - `backend/.env.example:262` = `postgres://USER:PASSWORD@HOST:5432/DBNAME`
- **Code references**:
  ...
  - `backend/services/ops/databaseBackup.js:L102` (process.env)
  ...
  - `scripts/restore-db.mjs:L58` (process.env)
...
- **Code references**:
  - `backend/db/index.js:L618` (process.env)

### `DB_PROVIDER`

- **Templates**:
  - `.env.example:296` = `sqlite`
  - `backend/.env.example:267` = `sqlite`
- **Code references**:
  ...
  - `backend/tests/applicationDraftsAtomicity.test.js:L21` (process.env)
  - `backend/tests/applicationWorkflowAtomicity.test.js:L26` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L4754` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L4757` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L4756` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L4755` (process.env)

### `DEDUPE_BASE_URL`

- **Templates**:
  - `.env.example:301` = `http://127.0.0.1:8080`
  - `backend/.env.example:272` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Code references**:
  - `backend/routes/admin.js:L5760` (process.env)
  - `backend/services/anyaAutonomousCrawler.js:L682` (process.env)
  - `backend/services/anyaAutonomousFunctionRunner.js:L95` (process.env)
...
- **Code references**:
  - `backend/routes/health.js:L595` (process.env)

### `DESIGNATED_PROFILES_FILE`

- **Templates**:
  - `.env.example:304` = ``
  - `backend/.env.example:275` = ``
- **Code references**:
...
- **Templates**:
  - `.env.example:305` = `<REPLACE_ME>`
  - `backend/.env.example:276` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  - `backend/server.js:L1504` (process.env)
...
- **Templates**:
  - `.env.example:313` = `http://127.0.0.1:8080`
  - `backend/.env.example:284` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:314` = `8080`
  - `backend/.env.example:285` = `8080`
- **Code references**:
...
- **Code references**:
  - `backend/routes/auth.js:L3269–L3373` (process.env)
...
- **Templates**:
  - `.env.example:318` = `<REPLACE_ME>`
  - `backend/.env.example:289` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  - `backend/server.js:L1517` (process.env)
  - `backend/startup/selfHeal.js:L268` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/enforceInvariants.test.js:L3926–L3934` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5563` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5185–L5271` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L2371` (process.env)
  - `backend/tests/enforceInvariants.test.js:L2266–L2364` (process.env)
...
- **Code references**:
  - `backend/tests/catalogRescoreSweep.test.js:L129–L143` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L6249` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5896–L5936` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L8758` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L4753` (process.env)
  - `backend/tests/enforceInvariants.test.js:L4481–L4495` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5880` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5357–L5418` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L6386` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5597–L5646` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L7886` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L6541` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5358–L6096` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L9165` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L2886` (process.env)
  - `backend/tests/enforceInvariants.test.js:L2731–L2738` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/enforceInvariants.test.js:L5050–L5059` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/enforceInvariants.test.js:L4653–L4759` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5262` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/enforceInvariants.test.js:L1948–L2093` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L2008` (process.env)
  - `backend/tests/enforceInvariants.test.js:L1598–L1723` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L794` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L7010` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5359–L5518` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L7396` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5654` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5707` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/enforceInvariants.test.js:L4907–L4914` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L6700` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L6850` (process.env)
  - `backend/tests/enforceInvariants.test.js:L2934–L3030` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L2823` (process.env)
  - `backend/tests/enforceInvariants.test.js:L2798–L2806` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L1958` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5393` (process.env)
  - `backend/tests/portalSyncStaleness.test.js:L564–L624` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5097` (process.env)
  - `backend/tests/enforceInvariants.test.js:L2898–L2905` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L7623` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L8162` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L639` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/enforceInvariants.test.js:L4289–L4302` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L8311` (process.env)
  - `backend/tests/stageOfLifeEligibility.test.js:L506` (process.env)

### `ENFORCE_STALE_MATCH_EXPLAIN`

- **Templates**:
  - `.env.example:365` = ``
  - `backend/.env.example:336` = ``
- **Code references**:
  - `backend/services/matching/staleMatchExplainRefresh.js:L68` (process.env)
  - `backend/tests/staleMatchExplainRefresh.test.js:L93–L129` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/enforceInvariants.test.js:L1793–L1855` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5948` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5718–L5777` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L3211` (process.env)
  - `backend/tests/enforceInvariants.test.js:L3489–L3497` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L1695` (process.env)
  - `backend/tests/enforceInvariants.test.js:L1529–L1537` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L8472` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L7210` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L2259` (process.env)
  - `backend/tests/enforceInvariants.test.js:L2146–L2220` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/enforceInvariants.test.js:L3282–L3411` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L2466` (process.env)

### `ENFORCE_XMATCH_PRECISION`

- **Templates**:
  - `.env.example:376` = ``
  - `backend/.env.example:347` = ``
- **Code references**:
  - `backend/startup/enforceInvariants.js:L6123` (process.env)
  - `backend/tests/enforceInvariants.test.js:L5805–L5835` (process.env)
...
- **Code references**:
  - `backend/services/errorReporter.js:L382` (process.env)
  - `backend/services/firstLoginNotifier.js:L72` (process.env)
  - `backend/tests/firstLoginNotifier.test.js:L99` (process.env)

### `ERROR_REPORT_LLM_ANALYSIS_ENABLED`

- **Templates**:
  - `.env.example:378` = `false`
  - `backend/.env.example:349` = `false`
- **Code references**:
  - `backend/services/errorReporter.js:L223` (process.env)
...
- **Templates**:
  - `.env.example:387` = `http://127.0.0.1:8080`
  - `backend/.env.example:358` = `http://127.0.0.1:8080`
- **Code references**:
  - `backend/routes/auth.js:L202` (process.env)
  - `backend/services/diagnosticsService.js:L416` (process.env)
...
- **Templates**:
  - `.env.example:389` = `http://127.0.0.1:8080`
  - `backend/.env.example:360` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:399` = ``
  - `backend/.env.example:370` = ``
- **Code references**:
  - `backend/routes/admin.js:L103–L2386` (process.env)
...
- **Code references**:
  - `backend/services/crawlers/nationalZipCrawler.js:L1786` (process.env)
...
- **Code references**:
  - `backend/routes/admin.js:L133` (process.env)
...
- **Code references**:
  - `backend/services/crawlers/nationalZipCrawler.js:L1544` (process.env)
...
- **Templates**:
  - `.env.example:408` = ``
  - `backend/.env.example:379` = ``
- **Code references**:
  - `backend/routes/admin.js:L99–L100` (process.env)
...
- **Templates**:
  ...
  - `backend/.env.example:381` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  ...
  - `backend/.env.example:390` = `<REPLACE_ME>`
- **Code references**:
  - `scripts/admin-dedupe-all-profiles.mjs:L17` (process.env)
...
- **Templates**:
  ...
  - `backend/.env.example:393` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:424` = ``
  - `backend/.env.example:395` = ``
- **Code references**:
  - `backend/routes/health.js:L73–L593` (process.env)
...
- **Code references**:
  - `backend/server.js:L596` (process.env)

### `GLOBAL_API_RATE_LIMIT_WINDOW_MS`

- **Templates**:
  - `.env.example:426` = ``
  - `backend/.env.example:397` = ``
- **Code references**:
...
- **Templates**:
  ...
  - `backend/.env.example:399` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:429` = `<REPLACE_ME>`
  - `backend/.env.example:400` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:430` = `<REPLACE_ME>`
  - `backend/.env.example:401` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:431` = `<REPLACE_ME>`
  - `backend/.env.example:402` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:433` = `<REPLACE_ME>`
  - `backend/.env.example:404` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:437` = `<REPLACE_ME>`
  - `backend/.env.example:408` = `<REPLACE_ME>`
- **Code references**:
  - `backend/services/shared/googleCseProvider.js:L30` (process.env)
  - `backend/services/shared/webSearchEngine.js:L72` (process.env)
  - `backend/tests/gfBatch05PurposeGuards.test.js:L64` (process.env)
...
- **Templates**:
  - `.env.example:439` = `<REPLACE_ME>`
  - `backend/.env.example:410` = `<REPLACE_ME>`
- **Code references**:
  - `scripts/hamilton-import-chrome-csv.mjs:L33` (process.env)
  - `scripts/hamilton-route-chrome-csv.mjs:L48` (process.env)
  - `scripts/scratch-scholarships-diag.mjs:L4` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/gfBatch05PurposeGuards.test.js:L69–L75` (process.env)
...
- **Templates**:
  - `.env.example:443` = `http://127.0.0.1:8080`
  - `backend/.env.example:414` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:445` = `<REPLACE_ME>`
  - `backend/.env.example:416` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:446` = `http://127.0.0.1:8080`
  - `backend/.env.example:417` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:447` = `<REPLACE_ME>`
  - `backend/.env.example:418` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:451` = `http://127.0.0.1:8080`
  - `backend/.env.example:422` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:452` = `http://127.0.0.1:8080`
  - `backend/.env.example:423` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Code references**:
  - `backend/services/missionHealthService.js:L123–L124` (process.env)
...
- **Code references**:
  - `backend/server.js:L320` (process.env)
  - `backend/startup/bootstrap.js:L425` (process.env)

### `GRANTFLOW_SIGNIN_URL`

- **Templates**:
  - `.env.example:458` = `http://127.0.0.1:8080`
  - `backend/.env.example:429` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Code references**:
  - `backend/routes/health.js:L518` (process.env)
  - `backend/server.js:L1060` (process.env)
...
- **Code references**:
  - `backend/server.js:L318` (process.env)
  - `backend/startup/bootstrap.js:L423` (process.env)

### `GRANTFLOW_SOFT_RELEVANCE_PENALTY`

- **Templates**:
  - `.env.example:461` = ``
  - `backend/.env.example:432` = ``
- **Code references**:
  - `backend/config/matchThresholds.js:L229` (process.env)
  - `backend/tests/matchThresholdsSoftPenalty.test.js:L3–L21` (process.env)
...
- **Templates**:
  - `.env.example:463` = `<REPLACE_ME>`
  - `backend/.env.example:434` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  ...
  - `scripts/run-vitest-isolated.mjs:L19` (process.env)
...
- **Templates**:
  - `.env.example:466` = `<REPLACE_ME>`
  - `backend/.env.example:437` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:467` = `<REPLACE_ME>`
  - `backend/.env.example:438` = `<REPLACE_ME>`
- **Code references**:
  - `backend/services/diagnosticsService.js:L403` (process.env)
  - `backend/services/realFundingCrawler.js:L33` (process.env)
  - `backend/services/shared/grantsGovApiClient.js:L35` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L3324` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L4118` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L4204` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/portalSyncLoginWallStatus.test.js:L104–L110` (process.env)
...
- **Code references**:
  - `backend/services/hamilton/hamiltonApplicationPacketGenerator.js:L520` (process.env)
...
- **Code references**:
  - `backend/services/hamilton/hamiltonFullProposalGenerator.js:L57` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L1794` (process.env)
  - `backend/tests/enforceInvariants.test.js:L1599–L1736` (process.env)
...
- **Code references**:
  - `backend/services/hamilton/hamiltonWeeklyDigest.js:L55` (process.env)
...
- **Code references**:
  - `backend/services/hamilton/hamiltonWeeklyDigest.js:L39` (process.env)
...
- **Code references**:
  - `backend/server.js:L4031` (process.env)
...
- **Code references**:
  - `backend/server.js:L3126` (process.env)

### `INDIVIDUAL_PIPELINE_AMOUNT_CEILING`

- **Templates**:
  - `.env.example:517` = ``
  - `backend/.env.example:488` = ``
- **Code references**:
  - `backend/startup/enforceInvariants.js:L727` (process.env)
  - `backend/tests/enforceInvariants.test.js:L602–L5533` (process.env)
...
- **Code references**:
  - `backend/services/matching/institutionRunRecall.js:L87` (env helper)
...
- **Templates**:
  - `.env.example:523` = `http://127.0.0.1:8080`
  - `backend/.env.example:494` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:524` = ``
  - `backend/.env.example:495` = ``
- **Code references**:
  - `backend/services/itemNeedSearch.js:L81` (process.env)
...
- **Code references**:
  - `backend/services/itemNeedSearch.js:L86` (process.env)

### `ITEM_SUGGESTIONS_PER_PROFILE`

- **Templates**:
  - `.env.example:528` = ``
  - `backend/.env.example:499` = ``
- **Code references**:
...
- **Code references**:
  - `backend/routes/realCrawlers.js:L904` (process.env)
...
- **Code references**:
  - `backend/routes/realCrawlers.js:L903` (process.env)

### `JOHN_ADMIN_TOKEN`

- **Templates**:
  - `.env.example:531` = `<REPLACE_ME>`
  - `backend/.env.example:502` = `<REPLACE_ME>`
- **Code references**:
  - `backend/routes/blocklist.js:L35` (process.env)
  - `backend/routes/emailGrants.js:L31` (process.env)
...
- **Templates**:
  - `.env.example:538` = `Annie | GrantFlow`
  - `backend/.env.example:509` = `Annie | GrantFlow`
- **Code references**:
...
- **Templates**:
  - `.env.example:540` = ``
  - `backend/.env.example:511` = ``
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5655` (process.env)
...
- **Templates**:
  ...
  - `backend/.env.example:513` = `Annie@axiombiolabs.org`
- **Code references**:
...
- **Templates**:
  - `.env.example:552` = `dr.johnwhite@axiombiolabs.org`
  - `backend/.env.example:523` = `dr.johnwhite@axiombiolabs.org`
- **Code references**:
...
- **Templates**:
  - `.env.example:554` = `Annie@axiombiolabs.org`
  - `backend/.env.example:525` = `Annie@axiombiolabs.org`
- **Code references**:
...
- **Code references**:
  - `backend/services/sam/samRegistry.js:L2146` (process.env)
...
- **Templates**:
  - `.env.example:567` = `<REPLACE_ME>`
  - `backend/.env.example:538` = `<REPLACE_ME>`
- **Code references**:
  - `backend/routes/authMe.js:L284` (process.env)
  - `backend/routes/health.js:L103` (process.env)
  - `backend/server.js:L1657–L1982` (process.env)
...
- **Templates**:
  - `.env.example:573` = `<REPLACE_ME>`
  - `backend/.env.example:544` = `<REPLACE_ME>`
- **Code references**:
  - `tools/laptop-connector/capture.js:L146` (process.env)
  - `tools/laptop-connector/scan.js:L102` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5708` (process.env)
...
- **Code references**:
  - `backend/routes/opportunities.js:L437` (process.env)
...
- **Code references**:
  - `backend/server.js:L3869–L3972` (process.env)
...
- **Code references**:
  - `backend/server.js:L3867` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L3488` (process.env)
...
- **Code references**:
  - `backend/services/matchEngine.js:L68` (process.env)
...
- **Code references**:
  - `backend/tests/enforceInvariants.test.js:L5999–L6017` (process.env)
...
- **Code references**:
  - `backend/routes/opportunities.js:L1391` (process.env)
...
- **Code references**:
  - `backend/routes/opportunities.js:L643` (process.env)
...
- **Code references**:
  - `backend/routes/profiles.js:L1308` (process.env)
...
- **Templates**:
  - `.env.example:604` = `<REPLACE_ME>`
  - `backend/.env.example:575` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  - `backend/server.js:L1513` (process.env)
  - `backend/startup/selfHeal.js:L262` (process.env)
...
- **Code references**:
  - `backend/routes/opportunities.js:L839` (process.env)
...
- **Code references**:
  - `backend/routes/health.js:L23` (process.env)
...
- **Code references**:
  ...
  - `src/utils/observability.js:L15` (import.meta.env)
...
- **Code references**:
  - `backend/server.js:L4075` (process.env)
...
- **Code references**:
  - `backend/services/promoAttribution.js:L55` (process.env)
...
- **Code references**:
  - `backend/server.js:L4375` (process.env)
  - `backend/services/sam/samRegistry.js:L1979–L2587` (process.env)
...
- **Code references**:
  - `backend/server.js:L4377` (process.env)
...
- **Code references**:
  - `backend/services/nationalPrograms/continuousRunner.js:L28` (process.env)
...
- **Code references**:
  - `backend/server.js:L4381` (process.env)
...
- **Code references**:
  - `backend/server.js:L4380` (process.env)
  - `backend/startup/backgroundServices.js:L376` (process.env)

### `NATIONWIDE_BATCH_SIZE`

- **Templates**:
  - `.env.example:623` = ``
  - `backend/.env.example:594` = ``
- **Code references**:
  - `scripts/nationwide-comprehensive-crawl.mjs:L77` (process.env)

### `NATIONWIDE_MIN_SOURCES_PER_ZIP`

- **Templates**:
  - `.env.example:624` = ``
  - `backend/.env.example:595` = ``
- **Code references**:
  - `scripts/nationwide-comprehensive-crawl.mjs:L76` (process.env)

### `NATIONWIDE_RATE_LIMIT_MS`

- **Templates**:
  - `.env.example:625` = ``
  - `backend/.env.example:596` = ``
- **Code references**:
  - `scripts/nationwide-comprehensive-crawl.mjs:L78` (process.env)

### `NEED_FIRST_RETAIN_UNANCHORED`

- **Templates**:
  - `.env.example:626` = ``
  - `backend/.env.example:597` = ``
- **Code references**:
...
- **Templates**:
  - `.env.example:630` = ``
  - `backend/.env.example:601` = ``
- **Code references**:
  - `backend/server.js:L4114` (process.env)
...
- **Code references**:
  ...
  - `backend/db/index.js:L11–L722` (process.env)
  - `backend/middleware/errorHandler.js:L15` (process.env)
  - `backend/routes/admin.js:L3746–L5760` (process.env)
  - `backend/routes/anya.js:L147–L222` (process.env)
  - `backend/routes/auth.js:L221–L3374` (process.env)
  - `backend/routes/grants.js:L2679–L2782` (process.env)
  - `backend/routes/health.js:L81–L519` (process.env)
  - `backend/routes/nofo.js:L662–L1138` (process.env)
  - `backend/routes/onboarding.js:L191–L526` (process.env)
  - `backend/routes/reminders.js:L221–L253` (process.env)
  - `backend/routes/version.js:L41` (process.env)
  ...
  - `backend/server.js:L206–L4367` (process.env)
  - `backend/services/agentControl/agentControlOrchestrator.js:L170` (process.env)
  - `backend/services/anyaAutonomousCrawler.js:L681` (process.env)
  - `backend/services/anyaAutonomousFunctionRunner.js:L94` (process.env)
  ...
  - `backend/services/avatarCrawler.js:L91–L279` (process.env)
  ...
  - `backend/services/hamilton/hamiltonApplicationPacketGenerator.js:L492–L806` (process.env)
  ...
  - `backend/services/http/safeFetch.js:L116` (process.env)
  - `backend/services/missionHealthService.js:L622` (process.env)
  - `backend/services/nationalPrograms/audit.js:L11` (process.env)
  - `backend/services/orgLogoFetcher.js:L203` (process.env)
  ...
  - `backend/tests/applicationDraftsAtomicity.test.js:L20` (process.env)
  - `backend/tests/applicationWorkflowAtomicity.test.js:L25` (process.env)
  - `backend/tests/avatarCrawlerSsrf.test.js:L12` (process.env)
...
- **Templates**:
  - `.env.example:636` = `20971520`
  - `backend/.env.example:607` = `20971520`
- **Code references**:
  - `backend/routes/nofo.js:L64` (process.env)

### `NOFO_FETCH_TIMEOUT_MS`

- **Templates**:
  - `.env.example:637` = `20000`
  - `backend/.env.example:608` = `20000`
- **Code references**:
  - `backend/routes/nofo.js:L338` (process.env)

### `NOFO_PARSE_CHUNK_CHARS`

- **Templates**:
  - `.env.example:638` = `14000`
  - `backend/.env.example:609` = `14000`
- **Code references**:
  - `backend/routes/nofo.js:L62` (process.env)

### `NOFO_PARSE_CHUNK_OVERLAP`

- **Templates**:
  - `.env.example:639` = `600`
  - `backend/.env.example:610` = `600`
- **Code references**:
  - `backend/routes/nofo.js:L63` (process.env)

### `NOFO_PARSE_MAX_TEXT_CHARS`

- **Templates**:
  - `.env.example:640` = `2000000`
  - `backend/.env.example:611` = `2000000`
- **Code references**:
  - `backend/routes/nofo.js:L61` (process.env)
...
- **Templates**:
  - `.env.example:646` = `<REPLACE_ME>`
  - `backend/.env.example:617` = `<REPLACE_ME>`
- **Code references**:
  - `backend/routes/admin.js:L987–L1485` (process.env)
...
- **Templates**:
  - `.env.example:650` = `http://127.0.0.1:8080`
  - `backend/.env.example:621` = `http://127.0.0.1:8080`
- **Code references**:
  - `backend/services/opportunityInserter.js:L639` (process.env)
...
- **Templates**:
  - `.env.example:654` = `<REPLACE_ME>`
  - `backend/.env.example:625` = `<REPLACE_ME>`
- **Code references**:
...
- **Code references**:
  - `backend/services/yana/yanaContactsImport.js:L115` (process.env)
...
- **Templates**:
  - `.env.example:660` = `<REPLACE_ME>`
  - `backend/.env.example:631` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:661` = `5432`
  - `backend/.env.example:632` = `5432`
- **Code references**:
...
- **Code references**:
  - `backend/db/index.js:L40–L614` (process.env)
...
- **Code references**:
  - `backend/db/index.js:L620` (process.env)

### `PG_POOL_IDLE_MS`

- **Templates**:
  - `.env.example:665` = ``
  - `backend/.env.example:636` = ``
- **Code references**:
  - `backend/db/index.js:L619` (process.env)

### `PG_POOL_MAX`

- **Templates**:
  - `.env.example:666` = ``
  - `backend/.env.example:637` = ``
- **Code references**:
  - `backend/db/index.js:L618` (process.env)
...
- **Code references**:
  - `backend/db/index.js:L621` (process.env)

### `PIPELINE_INSERT_RELEVANCE_FLOOR`

- **Templates**:
  - `.env.example:668` = ``
  - `backend/.env.example:639` = ``
- **Code references**:
...
- **Code references**:
  - `backend/server.js:L4165` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L117` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L94–L149` (process.env)
...
- **Code references**:
  - `backend/server.js:L2417` (process.env)
...
- **Templates**:
  - `.env.example:678` = `8080`
  - `backend/.env.example:649` = `8080`
- **Code references**:
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L5392` (process.env)
  - `backend/tests/portalSyncStaleness.test.js:L565` (process.env)
...
- **Templates**:
  - `.env.example:685` = `<REPLACE_ME>`
  - `backend/.env.example:656` = `<REPLACE_ME>`
- **Code references**:
  - `backend/db/index.js:L38` (process.env)
...
- **Templates**:
  - `.env.example:686` = `8080`
  - `backend/.env.example:657` = `8080`
- **Code references**:
  - `backend/db/index.js:L36` (process.env)
...
- **Templates**:
  - `.env.example:688` = `8080`
  - `backend/.env.example:659` = `8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:701` = `http://127.0.0.1:8080`
  - `backend/.env.example:672` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Code references**:
  ...
  - `backend/server.js:L208` (process.env)
...
- **Code references**:
  ...
  - `backend/routes/version.js:L42–L43` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/hamiltonAutomationOrchestratorOwnership.test.js:L15–L15` (process.env)
  ...
  - `backend/tests/portalSyncLoginWallStatus.test.js:L19–L19` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/gfBatch05PurposeGuards.test.js:L63–L95` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/grantsGovAmountAdapter.test.js:L249–L280` (process.env)
...
- **Code references**:
  ...
  - `backend/tests/applicationDraftsAtomicity.test.js:L22` (process.env)
  - `backend/tests/applicationWorkflowAtomicity.test.js:L27` (process.env)
  - `backend/tests/testServer.js:L20` (process.env)
  - `scripts/audit-section-metadata.mjs:L71` (process.env)
  - `scripts/backfill-opportunity-fields.mjs:L42` (process.env)
  - `scripts/restore-db.mjs:L35` (process.env)
...
- **Code references**:
  ...
  - `backend/services/hamilton/hamiltonApplicationPacketGenerator.js:L521` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L2468` (process.env)
...
- **Code references**:
  - `backend/startup/enforceInvariants.js:L2472` (process.env)

### `VERIFY_ADMIN_TOKEN`

- **Templates**:
  - `.env.example:918` = `<REPLACE_ME>`
  - `backend/.env.example:889` = `<REPLACE_ME>`
- **Code references**:
...
- **Templates**:
  - `.env.example:919` = `http://127.0.0.1:8080`
  - `backend/.env.example:890` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:920` = `http://127.0.0.1:8080`
  - `backend/.env.example:891` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:927` = `http://127.0.0.1:8080`
  - `backend/.env.example:898` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Code references**:
  ...
  - `src/components/auth/SocialSignInButtons.jsx:L133–L135` (import.meta.env)
...
- **Templates**:
  - `.env.example:25` = ``
- **Code references**:
  - `src/components/auth/SocialSignInButtons.jsx:L131` (import.meta.env)
  - `src/config/env.js:L42–L117` (import.meta.env)

### `VITE_PREVIEW_API_URL`

- **Templates**:
  - `.env.example:26` = `http://127.0.0.1:8080`
- **Code references**:
...
- **Templates**:
  - `.env.example:27` = ``
- **Code references**:
  - `src/utils/observability.js:L10` (import.meta.env)
...
- **Templates**:
  - `.env.example:29` = ``
- **Code references**:
  - `src/utils/observability.js:L17` (import.meta.env)
...
- **Templates**:
  - `.env.example:30` = ``
- **Code references**:
  - `src/utils/observability.js:L20` (import.meta.env)
...
- **Templates**:
  - `.env.example:944` = ``
  - `backend/.env.example:915` = ``
- **Code references**:
  - `backend/services/webParityBenchmark.js:L341` (process.env)
...
- **Templates**:
  - `.env.example:946` = ``
  - `backend/.env.example:917` = ``
- **Code references**:
  - `backend/server.js:L3971` (process.env)

### `X_ADMIN_TOKEN`

- **Templates**:
  - `.env.example:947` = `<REPLACE_ME>`
  - `backend/.env.example:918` = `<REPLACE_ME>`
- **Code references**:
  - `scripts/smoke-docs-local.mjs:L18` (process.env)
...
- **Templates**:
  - `.env.example:948` = ``
  - `backend/.env.example:919` = ``
- **Code references**:
  - `backend/server.js:L3246` (process.env)

### `YANA_BACKLOG_ENRICH_LIMIT`

- **Templates**:
  - `.env.example:949` = ``
  - `backend/.env.example:920` = ``
- **Code references**:
...
- **Templates**:
  - `.env.example:953` = ``
  - `backend/.env.example:924` = ``
- **Code references**:
  - `backend/services/sam/samRegistry.js:L2090` (process.env)
...
- **Templates**:
  - `.env.example:965` = `Bradley County, TN; Lorain County, OH; Erie County, OH`
  - `backend/.env.example:936` = `Bradley County, TN; Lorain County, OH; Erie County, OH`
- **Code references**:
...
- **Templates**:
  - `.env.example:966` = `http://127.0.0.1:8080`
  - `backend/.env.example:937` = `http://127.0.0.1:8080`
- **Code references**:
  - `backend/services/yana/yanaWebCrawler.js:L419` (process.env)

### `YANA_WEB_JSON_FEED_URL`

- **Templates**:
  - `.env.example:967` = `http://127.0.0.1:8080`
  - `backend/.env.example:938` = `http://127.0.0.1:8080`
- **Code references**:
  - `backend/services/yana/yanaWebCrawler.js:L406` (process.env)

### `ZIP_COUNTY_MAP_PATH`

- **Templates**:
  - `.env.example:968` = ``
  - `backend/.env.example:939` = ``
- **Code references**:
...
- **Templates**:
  - `.env.example:969` = ``
  - `backend/.env.example:940` = ``
- **Code references**:
  - `backend/routes/anya.js:L136` (process.env)
  - `backend/routes/health.js:L592` (process.env)
