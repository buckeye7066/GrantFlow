...
- **Code references**:
  - `GrantFlow-main/backend/config/constants.js:L11` (process.env)
  - `GrantFlow-main/backend/server.js:L87` (process.env)
  - `GrantFlow-main/backend/services/anyaOrchestrator.js:L12` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L57` (process.env)
  - `GrantFlow-main/scripts/ensure-admin-user.mjs:L19` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/config/constants.js:L18` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/adminLoginEventStore.js:L5` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/server.js:L86` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L56` (process.env)
  - `GrantFlow-main/scripts/ensure-admin-user.mjs:L21` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/ensure-admin-user.mjs:L20` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/anya.js:L19` (process.env)
  - `GrantFlow-main/backend/server.js:L85–L977` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L55–L819` (process.env)
  - `GrantFlow-main/scripts/dedupe-profiles.mjs:L29` (process.env)
  - `GrantFlow-main/scripts/diagnose-anya.mjs:L20` (process.env)
  - `GrantFlow-main/scripts/doctor.mjs:L77` (process.env)
  - `GrantFlow-main/scripts/run-all-real-crawlers.mjs:L5` (process.env)
  - `GrantFlow-main/tests/unit/api-contracts.test.mjs:L72` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L632` (process.env)
  - `GrantFlow-main/repo/backend/db/index.js:L379` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/server.js:L862` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L721` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/mockAI.js:L9` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L583` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/admin.js:L321–L324` (process.env)
  - `GrantFlow-main/backend/routes/ai.js:L37–L40` (process.env)
  - `GrantFlow-main/backend/routes/anya.js:L50–L110` (process.env)
  - `GrantFlow-main/backend/routes/nofo.js:L16–L19` (process.env)
  - `GrantFlow-main/backend/routes/profiles.js:L261–L264` (process.env)
  - `GrantFlow-main/backend/server.js:L957` (process.env)
  - `GrantFlow-main/backend/services/anyaOrchestrator.js:L37` (process.env)
  - `GrantFlow-main/backend/services/diagnosticsService.js:L232` (process.env)
  - `GrantFlow-main/backend/services/documentIngestion.js:L46–L510` (process.env)
  - `GrantFlow-main/backend/services/pipelineAutomation.js:L44` (process.env)
  - `GrantFlow-main/backend/utils/aiProviders.js:L8` (process.env)
  - `GrantFlow-main/scripts/diagnose-anya.mjs:L26–L40` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/utils/aiProviders.js:L15` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/admin.js:L384` (process.env)
  - `GrantFlow-main/backend/routes/ai.js:L102–L436` (process.env)
  - `GrantFlow-main/backend/routes/nofo.js:L128` (process.env)
  - `GrantFlow-main/backend/routes/profiles.js:L1098–L1261` (process.env)
  - `GrantFlow-main/backend/services/anyaOrchestrator.js:L62–L996` (process.env)
  - `GrantFlow-main/backend/services/documentIngestion.js:L564` (process.env)
  - `GrantFlow-main/backend/services/pipelineAutomation.js:L306` (process.env)
  - `GrantFlow-main/backend/utils/aiProviders.js:L101–L175` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/utils/aiProviders.js:L14` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/anya.js:L19` (process.env)
  - `GrantFlow-main/backend/server.js:L85–L977` (process.env)
  - `GrantFlow-main/backend/services/diagnosticsService.js:L237` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L55–L819` (process.env)
  - `GrantFlow-main/scripts/dedupe-profiles.mjs:L29` (process.env)
  - `GrantFlow-main/scripts/diagnose-anya.mjs:L20` (process.env)
  - `backend/routes/anya.js:L19` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/anyaOrchestrator.js:L32` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/anyaOrchestrator.js:L31` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/admin.js:L326` (process.env)
  - `GrantFlow-main/backend/routes/ai.js:L42` (process.env)
  - `GrantFlow-main/backend/routes/anya.js:L68` (process.env)
  - `GrantFlow-main/backend/routes/nofo.js:L21` (process.env)
  - `GrantFlow-main/backend/routes/profiles.js:L266` (process.env)
  - `GrantFlow-main/backend/services/anyaOrchestrator.js:L43` (process.env)
  - `GrantFlow-main/backend/services/documentIngestion.js:L52` (process.env)
  - `GrantFlow-main/backend/services/pipelineAutomation.js:L50` (process.env)
  - `GrantFlow-main/backend/utils/aiProviders.js:L15` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/admin.js:L325` (process.env)
  - `GrantFlow-main/backend/routes/ai.js:L41` (process.env)
  - `GrantFlow-main/backend/routes/anya.js:L67` (process.env)
  - `GrantFlow-main/backend/routes/nofo.js:L20` (process.env)
  - `GrantFlow-main/backend/routes/profiles.js:L265` (process.env)
  - `GrantFlow-main/backend/services/anyaOrchestrator.js:L42` (process.env)
  - `GrantFlow-main/backend/services/documentIngestion.js:L51` (process.env)
  - `GrantFlow-main/backend/services/pipelineAutomation.js:L49` (process.env)
  - `GrantFlow-main/backend/utils/aiProviders.js:L14` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/server.js:L783–L783` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L648–L648` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/server.js:L1819` (process.env)
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L15` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L1205` (process.env)
  - `GrantFlow-main/scripts/check-anya-status.mjs:L23–L107` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L24` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L26` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L38–L47` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L35` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L36` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L46` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L25` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L41` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L37` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/anyaOrchestrator.js:L18` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/anyaOrchestrator.js:L17` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/utils/openaiClient.js:L78` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/anyaOrchestrator.js:L61` (process.env)
  - `GrantFlow-main/backend/utils/aiProviders.js:L84–L143` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/utils/openaiClient.js:L73` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L1691` (process.env)
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L19` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L20` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/server.js:L1821` (process.env)
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L18` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L1207` (process.env)
  - `GrantFlow-main/scripts/check-anya-status.mjs:L24` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L42` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L30` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/anyaAutonomousScheduler.js:L43` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/smoke-auth-diagnostics.mjs:L12` (process.env)
  - `GrantFlow-main/tests/smoke/playwright.config.mjs:L4` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/diagnosticsService.js:L230` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/diagnose-anya.mjs:L19` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/profiles.js:L1623` (process.env)
  - `GrantFlow-main/repo/backend/routes/profiles.js:L1092` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L156` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L130` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L132` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L200` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L133` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L1394` (process.env)
  - `GrantFlow-main/backend/services/email.js:L89` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L156` (process.env)
  - `GrantFlow-main/backend/server.js:L297` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L192` (process.env)
  - `backend/routes/auth.js:L156` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L154` (process.env)
  - `GrantFlow-main/backend/services/diagnosticsService.js:L241` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L40` (process.env)
  - `GrantFlow-main/backend/server.js:L716–L974` (process.env)
  - `GrantFlow-main/backend/utils/runtimeSecrets.js:L19` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L592–L816` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/diagnosticsService.js:L236` (process.env)
  - `GrantFlow-main/backend/services/email.js:L10` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/diagnosticsService.js:L235` (process.env)
  - `GrantFlow-main/backend/services/email.js:L13–L14` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L136` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L134` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L207` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L135` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L153` (process.env)
  - `GrantFlow-main/backend/services/diagnosticsService.js:L240` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L131` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/runtime-crawl-local.mjs:L21` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/server.js:L555` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/repo/src/App.jsx:L74` (import.meta.env)
  - `GrantFlow-main/scripts/run-all-real-crawlers.mjs:L4` (process.env)
  - `GrantFlow-main/src/config/env.js:L25` (import.meta.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/server.js:L1482` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L996` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/crawlerV2.js:L9` (process.env)
  - `GrantFlow-main/backend/routes/crawlers.js:L1328–L2033` (process.env)
  - `GrantFlow-main/backend/server.js:L765–L978` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L636–L820` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/tests/smoke/playwright.config.mjs:L12–L25` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/server.js:L1212` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L985` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/godaddy-set-vercel-dns.mjs:L93` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/server.js:L114–L115` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L87–L88` (process.env)
  - `GrantFlow-main/scripts/doctor.mjs:L78` (process.env)
  - `GrantFlow-main/tests/unit/anya-tasks.test.mjs:L70` (process.env)
  - `GrantFlow-main/tests/unit/api-contracts.test.mjs:L73` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/crawler-doctor.mjs:L134` (process.env)
  - `GrantFlow-main/scripts/crawler-run.mjs:L25` (process.env)
  - `GrantFlow-main/scripts/crawler-smoke.mjs:L61` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/crawler-run.mjs:L26` (process.env)
  - `GrantFlow-main/scripts/crawler-smoke.mjs:L62` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/crawler-run.mjs:L22` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/crawlerV2.js:L38` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/crawler-run.mjs:L23` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/run-live-crawlers-all-profiles.mjs:L32` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/crawler-run.mjs:L27` (process.env)
  - `GrantFlow-main/scripts/crawler-smoke.mjs:L63` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/crawler-run.mjs:L24` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/migrations/run-migration.js:L15` (process.env)
  - `GrantFlow-main/scripts/fix-malformed-json.mjs:L20` (process.env)
  - `GrantFlow-main/scripts/ingest-grantsgov.mjs:L17` (process.env)
  - `GrantFlow-main/scripts/ingest-usaspending.mjs:L17` (process.env)
  - `GrantFlow-main/scripts/ingest.mjs:L18` (process.env)
  - `GrantFlow-main/scripts/seed-profile-grants.mjs:L18` (process.env)
  - `GrantFlow-main/scripts/seed-real-opportunities.mjs:L18` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/scripts/migrate-sqlite-to-postgres.mjs:L314` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L17` (process.env)
  - `GrantFlow-main/backend/import-data.js:L24` (process.env)
  - `GrantFlow-main/backend/scripts/migrate-sqlite-to-postgres.mjs:L314` (process.env)
  - `GrantFlow-main/repo/backend/db/index.js:L30–L358` (process.env)
  - `GrantFlow-main/scripts/crawler-doctor.mjs:L18` (process.env)
  - `GrantFlow-main/scripts/crawler-run.mjs:L19` (process.env)
  - `GrantFlow-main/scripts/opportunities-national-minimum.mjs:L20` (process.env)
  - `GrantFlow-main/scripts/run-live-crawlers-all-profiles.mjs:L30` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/server.js:L336` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L214` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L59` (process.env)
  - `GrantFlow-main/repo/backend/db/index.js:L27` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/diagnosticsService.js:L64–L239` (process.env)
  - `GrantFlow-main/backend/tests/crawlerMatrixTest.js:L26` (process.env)
  - `GrantFlow-main/scripts/build-seed-db.mjs:L41` (process.env)
  - `GrantFlow-main/scripts/check-profiles.mjs:L45–L46` (process.env)
  - `GrantFlow-main/scripts/crawler-smoke.mjs:L17` (process.env)
  - `GrantFlow-main/scripts/db-opportunity-tag-stats.cjs:L3` (process.env)
  - `GrantFlow-main/scripts/db-term-coverage.cjs:L3` (process.env)
  - `GrantFlow-main/scripts/db-top-tags.cjs:L3` (process.env)
  - `GrantFlow-main/scripts/db-url-stats.cjs:L3` (process.env)
  - `GrantFlow-main/scripts/ensure-admin-user.mjs:L24` (process.env)
  - `GrantFlow-main/scripts/reattach-users-simple.mjs:L10–L11` (process.env)
  - `GrantFlow-main/scripts/run-crawlers.mjs:L23–L24` (process.env)
  - `GrantFlow-main/scripts/seed-profiles.mjs:L44–L45` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L58` (process.env)
  - `GrantFlow-main/repo/backend/db/index.js:L26` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/dedupe-profiles.mjs:L28` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/repo/src/api/client.js:L9–L15` (import.meta.env)
  - `GrantFlow-main/repo/src/components/auth/AuthErrorBoundary.jsx:L84` (import.meta.env)
  - `GrantFlow-main/repo/src/components/shared/ErrorBoundary.jsx:L16` (import.meta.env)
  - `GrantFlow-main/src/api/auth.js:L4–L11` (import.meta.env)
  - `GrantFlow-main/src/api/client.js:L15` (import.meta.env)
  - `GrantFlow-main/src/components/auth/AuthErrorBoundary.jsx:L84` (import.meta.env)
  - `GrantFlow-main/src/components/shared/ErrorBoundary.jsx:L16` (import.meta.env)
  - `GrantFlow-main/src/config/env.js:L23` (import.meta.env)
...
- **Code references**:
  - `GrantFlow-main/repo/backend/server.js:L553` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/server.js:L623` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L491` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/config/features.js:L8` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/config/features.js:L9` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/config/features.js:L11` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/config/features.js:L10` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/config/features.js:L7` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/build-seed-db.mjs:L17–L52` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/diagnosticsService.js:L234` (process.env)
  - `GrantFlow-main/backend/services/email.js:L9` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/src/config/apiKeys.js:L71` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/admin.js:L52–L1195` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/admin.js:L48–L49` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/server.js:L1211` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L984` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/countyFundingCrawler.js:L70` (process.env)
  - `GrantFlow-main/repo/backend/services/countyFundingCrawler.js:L70` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/countyFundingCrawler.js:L71` (process.env)
  - `GrantFlow-main/repo/backend/services/countyFundingCrawler.js:L71` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/diagnosticsService.js:L228` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L40` (process.env)
  - `GrantFlow-main/backend/server.js:L716–L974` (process.env)
  - `GrantFlow-main/backend/utils/runtimeSecrets.js:L20` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L592–L816` (process.env)
  - `backend/routes/auth.js:L40` (process.env)
  - `backend/server.js:L715–L973` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/db-top-tags.cjs:L5` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/realCrawlers.js:L34` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/realCrawlers.js:L32` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/run-live-crawlers-all-profiles.mjs:L33` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/start.js:L88–L88` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/start.js:L89–L89` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/realCrawlers.js:L33` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/server.js:L619` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L487` (process.env)
  - `GrantFlow-main/scripts/opportunities-national-minimum.mjs:L132` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/opportunities.js:L246` (process.env)
  - `GrantFlow-main/scripts/opportunities-national-minimum.mjs:L79` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/server.js:L1841` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L1227` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/server.js:L1843` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L1229` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/server.js:L1847` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L1233` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/server.js:L1846` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L1232` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/config/env.js:L78–L176` (process.env)
  - `GrantFlow-main/backend/db/index.js:L80` (process.env)
  - `GrantFlow-main/backend/middleware/errorHandler.js:L13` (process.env)
  - `GrantFlow-main/backend/routes/anya.js:L47–L117` (process.env)
  - `GrantFlow-main/backend/routes/auth.js:L41–L2232` (process.env)
  - `GrantFlow-main/backend/routes/nofo.js:L157` (process.env)
  - `GrantFlow-main/backend/routes/reminders.js:L188–L213` (process.env)
  - `GrantFlow-main/backend/server.js:L67–L1808` (process.env)
  - `GrantFlow-main/backend/services/anyaTestRepair.js:L155` (process.env)
  - `GrantFlow-main/backend/services/diagnosticsService.js:L30–L238` (process.env)
  - `GrantFlow-main/backend/services/email.js:L15–L81` (process.env)
  - `GrantFlow-main/backend/services/mockAI.js:L9` (process.env)
  - `GrantFlow-main/backend/src/config/apiKeys.js:L100` (process.env)
  - `GrantFlow-main/repo/backend/config/env.js:L70–L168` (process.env)
  - `GrantFlow-main/repo/backend/db/index.js:L35` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L215–L1194` (process.env)
  - `GrantFlow-main/scripts/build-seed-db.mjs:L15` (process.env)
  - `GrantFlow-main/scripts/seed-profiles.mjs:L28` (process.env)
  - `GrantFlow-main/tests/smoke/playwright.config.mjs:L25` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/nofo.js:L8` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/admin.js:L500–L592` (process.env)
  - `GrantFlow-main/backend/routes/anya.js:L115` (process.env)
  - `GrantFlow-main/backend/scripts/create-profile-from-pdf.mjs:L74` (process.env)
  - `GrantFlow-main/backend/scripts/dispatch-crawlers.mjs:L9` (process.env)
  - `GrantFlow-main/backend/scripts/fix-anastasia-profile.mjs:L9` (process.env)
  - `GrantFlow-main/backend/scripts/process-all-jobs.mjs:L9` (process.env)
  - `GrantFlow-main/backend/scripts/process-anastasia-ai.mjs:L6` (process.env)
  - `GrantFlow-main/backend/scripts/process-queue.mjs:L10` (process.env)
  - `GrantFlow-main/backend/scripts/read-anastasia-vision.mjs:L5` (process.env)
  - `GrantFlow-main/backend/server.js:L356–L956` (process.env)
  - `GrantFlow-main/backend/services/anyaToolRegistry.js:L752` (process.env)
  - `GrantFlow-main/backend/services/diagnosticsService.js:L231` (process.env)
  - `GrantFlow-main/backend/utils/openaiClient.js:L29–L55` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L236–L804` (process.env)
  - `GrantFlow-main/scripts/fix-api-errors.mjs:L25–L27` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/config/constants.js:L52` (process.env)
  - `GrantFlow-main/backend/routes/admin.js:L37` (process.env)
  - `GrantFlow-main/backend/routes/nofo.js:L9` (process.env)
  - `GrantFlow-main/backend/routes/profiles.js:L1068–L1238` (process.env)
  - `GrantFlow-main/backend/services/pipelineAutomation.js:L286` (process.env)
  - `GrantFlow-main/backend/utils/aiProviders.js:L84–L143` (process.env)
  - `GrantFlow-main/repo/backend/routes/profiles.js:L784` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/scripts/read-anastasia-vision.mjs:L6` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L25` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L21` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L24` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L22` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L26` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L23` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L489` (process.env)
  - `GrantFlow-main/repo/backend/db/index.js:L279` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L488` (process.env)
  - `GrantFlow-main/repo/backend/db/index.js:L278` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L487` (process.env)
  - `GrantFlow-main/repo/backend/db/index.js:L277` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/server.js:L103` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L66–L74` (process.env)
  - `GrantFlow-main/tests/smoke/playwright.config.mjs:L24` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/src/config/env.js:L24` (import.meta.env)
  - `GrantFlow-main/src/utils/enforceCanonicalHost.js:L4` (import.meta.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L91` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/server.js:L1483` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L997` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L51–L88` (process.env)
  - `GrantFlow-main/backend/routes/auth.js:L1438` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L90` (process.env)
  - `GrantFlow-main/backend/server.js:L1210` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L983` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L52–L86` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L53–L87` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L89` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/requestIdErrorStore.js:L1` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/server.js:L172` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L146` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/diagnosticsService.js:L233` (process.env)
  - `GrantFlow-main/backend/services/email.js:L8` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/utils/runtimeSecrets.js:L4` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/start.js:L74` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/anyaToolRegistry.js:L753` (process.env)
  - `GrantFlow-main/backend/services/connectors/samGovConnector.js:L61–L118` (process.env)
  - `GrantFlow-main/backend/services/diagnosticsService.js:L227` (process.env)
  - `GrantFlow-main/tests/unit/funding-api-keys.test.mjs:L32–L37` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/services/diagnosticsService.js:L227` (process.env)
  - `GrantFlow-main/tests/unit/funding-api-keys.test.mjs:L31–L36` (process.env)
  - `backend/services/diagnosticsService.js:L227` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/admin.js:L1572` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/seed-profiles.mjs:L51–L52` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/serviceApplication.js:L8` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/utils/runtimeSecrets.js:L21` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/services/diagnosticsService.js:L229` (process.env)
  - `GrantFlow-main/tests/unit/funding-api-keys.test.mjs:L11–L35` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/doctor.mjs:L180` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/smoke-docs-local.mjs:L18` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/doctor.mjs:L178` (process.env)
  - `GrantFlow-main/scripts/smoke-auth-callback.mjs:L49` (process.env)
  - `GrantFlow-main/scripts/smoke-auth-refresh.mjs:L51` (process.env)
  - `GrantFlow-main/scripts/smoke-login.mjs:L29` (process.env)
  - `GrantFlow-main/scripts/smoke-organization-profile.mjs:L51` (process.env)
  - `GrantFlow-main/scripts/smoke-prod-readonly.mjs:L14` (process.env)
  - `GrantFlow-main/tests/smoke/playwright.config.mjs:L5` (process.env)
...
- **Code references**:
  - `GrantFlow-main/scripts/dedupe-profiles.mjs:L28` (process.env)
  - `GrantFlow-main/scripts/runtime-crawl-local.mjs:L20` (process.env)
  - `GrantFlow-main/scripts/smoke-auth-callback.mjs:L17` (process.env)
  - `GrantFlow-main/scripts/smoke-auth-refresh.mjs:L19` (process.env)
  - `GrantFlow-main/scripts/smoke-login.mjs:L16` (process.env)
  - `GrantFlow-main/scripts/smoke-organization-profile.mjs:L19` (process.env)
  - `GrantFlow-main/scripts/smoke-prod-readonly.mjs:L13` (process.env)
  - `GrantFlow-main/tests/smoke/playwright.config.mjs:L4` (process.env)
  - `scripts/dedupe-profiles.mjs:L28` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/smoke-prod-readonly.mjs:L15` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/smoke-login.mjs:L58–L72` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/doctor.mjs:L184` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/doctor.mjs:L185` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/doctor.mjs:L183` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/smoke-login.mjs:L30` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/db-top-tags.cjs:L4` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/db/index.js:L101` (process.env)
  - `GrantFlow-main/backend/scripts/migrate-sqlite-to-postgres.mjs:L312` (process.env)
  - `GrantFlow-main/backend/start.js:L17` (process.env)
  - `GrantFlow-main/repo/backend/db/index.js:L44` (process.env)
  - `GrantFlow-main/scripts/crawler-smoke.mjs:L18` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/opportunities-national-minimum.mjs:L133` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L148` (process.env)
  - `GrantFlow-main/backend/services/diagnosticsService.js:L242` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L149` (process.env)
  - `GrantFlow-main/backend/services/diagnosticsService.js:L242` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L151` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L150` (process.env)
...
- **Code references**:
  - `GrantFlow-main/backend/routes/admin.js:L42–L43` (process.env)
  - `GrantFlow-main/backend/routes/documents.js:L29–L30` (process.env)
  - `GrantFlow-main/backend/routes/profiles.js:L125–L126` (process.env)
  - `GrantFlow-main/backend/server.js:L94–L95` (process.env)
  - `GrantFlow-main/tests/unit/release-hardening.test.mjs:L30–L31` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/routes/auth.js:L1439` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/backend/server.js:L1213` (process.env)
  - `GrantFlow-main/repo/backend/server.js:L986` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/verify-login.mjs:L5` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/verify-login.mjs:L4` (process.env)
...
- **Code references**:
  - `GrantFlow-main/repo/src/api/client.js:L10–L20` (import.meta.env)
  - `GrantFlow-main/src/api/client.js:L16–L20` (import.meta.env)
  - `GrantFlow-main/src/components/auth/SocialSignInButtons.jsx:L35–L63` (import.meta.env)
  - `GrantFlow-main/src/config/env.js:L27` (import.meta.env)
...
- **Code references**:
  ...
  - `GrantFlow-main/repo/backend/server.js:L192` (process.env)
  - `GrantFlow-main/repo/src/App.jsx:L74` (import.meta.env)
  - `GrantFlow-main/repo/src/api/client.js:L12` (import.meta.env)
  - `GrantFlow-main/scripts/doctor.mjs:L79–L178` (process.env)
  - `GrantFlow-main/src/components/auth/SessionExpiredDialog.jsx:L10` (import.meta.env)
  - `GrantFlow-main/src/components/auth/SocialSignInButtons.jsx:L24` (import.meta.env)
  - `GrantFlow-main/src/config/env.js:L26` (import.meta.env)
  - `GrantFlow-main/tests/smoke/playwright.config.mjs:L5` (process.env)
  - `GrantFlow-main/tests/unit/anya-tasks.test.mjs:L71` (process.env)
  - `GrantFlow-main/tests/unit/api-contracts.test.mjs:L74` (process.env)
  - `backend/routes/auth.js:L156` (process.env)
  - `backend/server.js:L297` (process.env)
  - `repo/backend/server.js:L192` (process.env)
  - `repo/src/App.jsx:L74` (import.meta.env)
...
- **Code references**:
  - `GrantFlow-main/scripts/doctor.mjs:L167` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/src/config/env.js:L28` (import.meta.env)
  - `GrantFlow-main/src/utils/enforceCanonicalHost.js:L6` (import.meta.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/src/config/env.js:L29` (import.meta.env)
  - `GrantFlow-main/src/utils/enforceCanonicalHost.js:L11` (import.meta.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/src/pages/Login.jsx:L71` (import.meta.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/src/lib/firebase.js:L5` (import.meta.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/src/lib/firebase.js:L10` (import.meta.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/src/lib/firebase.js:L6` (import.meta.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/src/lib/firebase.js:L9` (import.meta.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/src/lib/firebase.js:L7` (import.meta.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/src/lib/firebase.js:L8` (import.meta.env)
...
- **Templates**: (not present)
- **Code references**:
  - `GrantFlow-main/scripts/smoke-docs-local.mjs:L19` (process.env)
