...
- **Code references**:
  ...
  - `backend/server.js:L69–L963` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L895` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L822–L822` (process.env)
...
- **Code references**:
  - `backend/server.js:L1382` (process.env)
...
- **Code references**:
  - `backend/server.js:L1384` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/routes/profiles.js:L1135` (process.env)
...
- **Code references**:
  - `backend/routes/auth.js:L154` (process.env)
  - `backend/server.js:L276` (process.env)
...
- **Code references**:
  ...
  - `backend/server.js:L741–L960` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L535` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L1140` (process.env)
...
- **Code references**:
  ...
  - `backend/server.js:L804–L964` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L1129` (process.env)
...
- **Code references**:
  - `backend/server.js:L106–L107` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/routes/admin.js:L1512` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L658` (process.env)
...
- **Code references**:
  - `backend/routes/admin.js:L56–L57` (process.env)
...
- **Code references**:
  - `backend/routes/admin.js:L46–L53` (process.env)

### `GIT_COMMIT_SHA`

- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L1128` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L654` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L1404` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L1406` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L1410` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L1409` (process.env)
...
- **Code references**:
  ...
  - `backend/server.js:L62–L1371` (process.env)
...
- **Code references**:
  - `backend/routes/admin.js:L377–L469` (process.env)
  ...
  - `backend/server.js:L342–L948` (process.env)
...
- **Code references**:
  ...
  - `backend/routes/profiles.js:L775` (process.env)
...
- **Code references**:
  - `backend/server.js:L95` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L1141` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L1127` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/routes/admin.js:L1271` (process.env)
...
- **Code references**:
  ...
  - `backend/routes/profiles.js:L36–L37` (process.env)
  - `backend/server.js:L78–L88` (process.env)
...
- **Templates**: (not present)
- **Code references**:
  - `backend/server.js:L1130` (process.env)
